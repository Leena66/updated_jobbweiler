...
if( $allow_register != 'none' ) :
	...
	<form class="noo-ajax-register-form form-horizontal" action="<?php echo esc_url( wp_registration_url() ); ?>" method="post" id="registerform">
		...
		<?php if( $allow_register == 'both' ) : ?>
			<div class="form-group row required-field"  style="visibility:hidden">
				...
				<div class="col-sm-9">
					<div class="form-control-flat">
						<select class="user_role" name="user_role" required>
							...
							<option selected="selected" value="candidate" <?php selected( $role, 'candidate' ); ?>><?php esc_html_e('I\'m a candidate looking for a job','noo')?></option>
						</select>
