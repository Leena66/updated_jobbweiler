...
class JSJOBSResumeFormlayout {
    ...
    function getResumeFormUserFieldJobManager($title, $field,$required) {
        ...
        <div class="js-col-md-12 js-form-title jsjb-jm-bigfont">' . $title; 
        if($required==1){
            $html .= '<span class="jsjb-jm-error-msg">*</span>';
        }
        $html .= '</div>
    ...
    function getResumeSelectFieldJobManager($fieldtitle,$fieldName,$fieldValue,$required,$column){
        $html="";
        if($column==4){
            $html .= '<div class="js-col-md-3 jsjb-jm-field-padding">';
        }else{
            $html .= '<div class="js-col-md-12 js-form-wrapper">';

        }
        $html .= '
            <div class="js-col-md-12 js-form-title jsjb-jm-bigfont">' . $fieldtitle;
            if($required==1){
                $html .='<span class="jsjb-jm-error-msg">*</span>';    
            }
            $html .='</div>
    ...
    function getResumeSectionTitleJobManager($sectionid,$imagename,$imagealt,$title) {
        ...
        $html='<div id="jsresume_sectionid'.$sectionid.'" class="jsjb-jm-addresume-title-wrap">
                <span class="jsjb-jm-addresume-icon"> 
                    <img alt="'.$imagealt.'" title="'.$title.'" src="'.JOB_MANAGER_IMAGE.'/'.$imagename.'">
                </span>
                <h3 class="jsjb-jm-addresume-title">
                    ' . __($title, 'js-jobs') . '
                </h3>
            </div>';
        ...
        switch ($sectionFor) {
            case 'personal':
                if(null!=$themecall){
                    ...
                    $html = '<div id="jsresume_sectionid'.$sectionid.'" class="resume-section-title personal"><img class="heading-img" src="' . jsjobs::$_pluginpath . 'includes/images/personal-info.png" />' . __($title, 'js-jobs') . '</div>';
                }
            break;
            case 'address':
                if(null!=$themecall){
                    ...
                    $html = '<div id="jsresume_sectionid'.$sectionid.'" class="resume-section-title "><img class="heading-img" src="' . jsjobs::$_pluginpath . 'includes/images/word.png" />' . __($title, 'js-jobs') . '</div>';
                }
            ...
            case 'institute':
                if(null!=$themecall){
                    ...
                    $html = '<div id="jsresume_sectionid'.$sectionid.'" class="resume-section-title "><img class="heading-img" src="' . jsjobs::$_pluginpath . 'includes/images/education.png" />' . __($title, 'js-jobs') . '</div>';
                }
            ...
            case 'employer':
                if(null!=$themecall){
                    ...
                    $html = '<div id="jsresume_sectionid'.$sectionid.'" class="resume-section-title "><img class="heading-img" src="' . jsjobs::$_pluginpath . 'includes/images/employer.png" />' . __($title, 'js-jobs') . '</div>';
                }
            ...
            case 'skills':
                if(null!=$themecall){
                    ...
                    $html = '<div id="jsresume_sectionid'.$sectionid.'" class="resume-section-title "><img class="heading-img" src="' . jsjobs::$_pluginpath . 'includes/images/skills.png" />' . __($title, 'js-jobs') . '</div>';
                }
            ...
            case 'editor':
                if(null!=$themecall){
                    ...
                    $html = '<div id="jsresume_sectionid'.$sectionid.'" class="resume-section-title "><img class="heading-img" src="' . jsjobs::$_pluginpath . 'includes/images/resume.png" />' . __($title, 'js-jobs') . '</div>';
                }
            ...
            case 'reference':
                if(null!=$themecall){
                    ...
                    $html = '<div id="jsresume_sectionid'.$sectionid.'" class="resume-section-title "><img class="heading-img" src="' . jsjobs::$_pluginpath . 'includes/images/referances.png" />' . __($title, 'js-jobs') . '</div>';
                }
            ...
            case 'language':
                if(null!=$themecall){
                    ...
                    $html = '<div id="jsresume_sectionid'.$sectionid.'" class="resume-section-title "><img class="heading-img" src="' . jsjobs::$_pluginpath . 'includes/images/language.png" />' . __($title, 'js-jobs') . '</div>';
                }
    ...
    function getFieldForPersonalSectionJobManager($fieldtitle,$fieldName,$fieldValue,$required,$columns = 0,$extraattr){

        $data="";

        if($columns == 3){
            $data .= '<div class="js-col-md-4 jsjb-jm-field-padding">';
        }else{
            $data .= '<div class="js-col-md-12 js-form-wrapper">';
        }
        $data .= '
            <div class="js-col-md-12 js-form-title jsjb-jm-bigfont">' . __($fieldtitle,'js-jobs');
            if ($required == 1) {
                $data .= '<span class="jsjb-jm-error-msg">*</span>';
            }
            $data .='</div>
            <div class="js-col-md-12 js-form-value">';
                $data .='<input class="inputbox form-control jsjb-jm-input-field';
    ...
    function getFieldForMultiSectionJobManager($fieldtitle,$fieldName,$required,$fieldValue,$field_id_for,$section, $sectionid, $ishidden){
            $html = '<div class="js-col-md-12 js-form-wrapper">
            <div class="js-col-md-12 js-form-title jsjb-jm-bigfont" for="'.$field_id_for.'">' . __($fieldtitle,'js-jobs');
                if ($required == 1) {
                    $html .= '<span class="jsjb-jm-error-msg">*</span>';
                }
              $html .='</div>
            <div class="js-col-md-12 js-form-value">';
                ...
                $html .= '<input class="inputbox form-control jsjb-jm-input-field '.$class_required.'" '.$data_required;
        ...
        $html .= '</label>
                ...
                /*$html .= '  <script type="text/javascript">
                                jQuery(document).ready(function(){
                                    getTokenInput('.$field_city_id.' ,'. $edit_field_city_id.' );
                                });
                            </script>';*/
    ...
    function makeLanguageSectionFields($themecall=null){
        ...
        foreach ($languages as $language) {
            ...
            $html .= '<div class="section_wrapper form jssection_wrapper '.$jssection_hide.' jssection_language_'.$sectionid.'">
                        <div class="jsundo"><img class="jsundoimage" onclick="undoThisSection(this);" src="'.jsjobs::$_pluginpath.'includes/images/resume/undo-icon.png" /></div>
                        <img class="jsdeleteimage" onclick="deleteThisSection(this);" src="'.jsjobs::$_pluginpath.'includes/images/resume/delete-icon.png" />';
            foreach (jsjobs::$_data[2][8] as $field) {
                switch ($field->field) {
                    case "language":
                        $fvalue = isset($language->language) ? $language->language : '';
                        $html .= $this->getFieldForMultiSection($field, $fvalue, 8, $sectionid, $jssection_hide,$themecall);
                        break;
            ...
            $html .= '<input type="hidden" id="deletethis8'.$sectionid.'" class="jsdeletethissection" name="sec_8[deletethis]['.$sectionid.']" value="'.$deletethis.'">
                    ...
                    if(null !=$themecall){                        
                        $html .= '<hr class="jsjb-jm-resume-section-sep" />';
                    }
                    $html .='</div>';
            $sectionid++;
        }
        ...
        if($j > 0){
            if(null !=$themecall){
                $html .= '<div class="jsresume_addnewbutton jsjb-jm-resume-addnewbutton" onclick="showResumeSection( this ,\'language\');">
                <span class="jsjb-jm-addresume-addfield-btn-txt"><i class="fa fa-plus-square-o" aria-hidden="true"></i>'.__('Add New','js-jobs').'&nbsp;'. __('Language','js-jobs').'
                </span></div>';
            }else{
    ...
    function makeReferenceSectionFields($themecall=null){
            ...
            foreach (jsjobs::$_data[2][7] as $field) {
                switch ($field->field) {
                    case "reference":
                        ...
                        $html .= $this->getFieldForMultiSection($field, $fvalue, 7, $sectionid, $jssection_hide,$themecall);
                        break;
                    case "reference_name":
        ...
        if($j > 0){
            if(null !=$themecall){
                $html .= '<div class="jsresume_addnewbutton jsjb-jm-resume-addnewbutton" onclick="showResumeSection( this ,\'reference\');">
                <span class="jsjb-jm-addresume-addfield-btn-txt"><i class="fa fa-plus-square-o" aria-hidden="true"></i>'.__('Add New','js-jobs').'&nbsp;'. __('Reference','js-jobs').'
                </span></div>';
            }else{
    ...
    function makeResumeSectionFields($themecall=null){
        ...
        foreach (jsjobs::$_data[2][6] as $field) {
            switch ($field->field) {
                case "resume":
                    ...
                    $efield = JSJOBSformfield::textarea('resume', $value, array('class' => 'inputbox one resumeeditor form-control jsjb-jm-textarea-field', 'height'=>'270px','rows'=>'10','cols'=>'40'));
        ...
        if(empty($resume->resume)){
            if(null !=$themecall){
                $html .= '<div class="jsresume_addnewbutton jsjb-jm-resume-addnewbutton" onclick="showResumeSection( this ,\'resume\');">
                <span class="jsjb-jm-addresume-addfield-btn-txt"><i class="fa fa-plus-square-o" aria-hidden="true"></i>'.__('Add Resume','js-jobs').'
                </span></div>';
            }else{            
    ...
    function makeSkillsSectionFields($themecall=null){
        ...
        foreach (jsjobs::$_data[2][5] as $field) {
            switch ($field->field) {
                case "skills":
                    ...
                    $html .= '</label>
                            <div class="row-value resumefieldvalue">
                                <textarea  class="inputbox '.$resume_required.' form-control jsjb-jm-textarea-field" '.$data_required.' name="skills" id="skills" cols="180" rows="5" >'.$fvalue.'</textarea>
                            </div>
                        </div>';
                    break;
                default:
        ...
        if(empty($skills->skills)){
            if(null !=$themecall){
                $html .= '<div class="jsresume_addnewbutton jsjb-jm-resume-addnewbutton" onclick="showResumeSection( this ,\'skills\');">
                <span class="jsjb-jm-addresume-addfield-btn-txt"><i class="fa fa-plus-square-o" aria-hidden="true"></i>'.__('Add Skills','js-jobs').'
                </span></div>';
            }else{            
    ...
    function makeAddressSectionFields($themecall=null) {
                        ...
                        $html .='<div class="resume-row-wrapper form js-col-md-12 js-form-wrapper">
                            <div class="resumefieldswrapper loc-field">
                                <label id="longitudemsg" class="resumefieldtitle" for="longitude">' . __($field->fieldtitle,'js-jobs');
                                    if ($field->required == 1) {
                                        $html .= '<span class="jsjb-jm-error-msg error-msg">*</span>';
                                    }
                        $html .= '</label>
                                <div class="resumefieldvalue">
                                    <div id="outermapdiv_'.$sectionid.'" class="outermapdiv">
                                        <div id="map_'.$sectionid.'" class="map" style="width:' . JSJOBSincluder::getJSModel('configuration')->getConfigurationByConfigName('mapwidth') . 'px; height:' . JSJOBSincluder::getJSModel('configuration')->getConfigurationByConfigName('mapheight'). 'px;visibility:hidden;display:none;">
                                            <div id="closetag_'.$sectionid.'"><a class="js-resume-close-cross" href="Javascript: hidediv('.$sectionid.');">' . __('X','js-jobs') . '</a></div>
                                ...
                                <div class="resumefieldvalueform">
                                    <div class="js-col-xs-12 js-col-md-4 leftpaddingnull">
                                        <input  class="inputbox form-control jsjb-jm-input-field ' . $required . '" '.$data_required.' type="text" id="latitude_'.$sectionid.'" name="sec_2[latitude]['.$sectionid.']" size="25" placeholder="' . __('Latitude','js-jobs') . '" value = "'.$latitude.'" />
                                    </div>
                                    <div class="js-col-xs-12 js-col-md-4 leftpaddingnull">
                                        <input  class="inputbox form-control jsjb-jm-input-field' . $required . '" '.$data_required.' type="text" id="longitude_'.$sectionid.'" name="sec_2[longitude]['.$sectionid.']" size="25" placeholder="' . __('Longitude','js-jobs') . '" value = "'.$longitude.'" />
                                    </div>
                                    <div class="js-col-xs-12 js-col-md-4 leftpaddingnull">
                                        <a class="anchor map-link" href="Javascript: showdiv('.$sectionid.');loadMap('.$sectionid.');"><span id="anchor">' . __('Map','js-jobs') . '</span></a>
                                    </div>
                                </div>
                            </div></div>';
                    break;
        ...
        if($j > 0){
            if(null !=$themecall){
                $html .= '<div class="jsresume_addnewbutton jsjb-jm-resume-addnewbutton" onclick="showResumeSection( this ,\'address\');">
                <span class="jsjb-jm-addresume-addfield-btn-txt"><i class="fa fa-plus-square-o" aria-hidden="true"></i>'.__('Add New','js-jobs').'&nbsp;'. __('Address','js-jobs').'
                </span></div>';
            }else{
    ...
    function makeInstituteSectionFields($themecall=null){
            ...
            foreach (jsjobs::$_data[2][3] as $field) {
                switch ($field->field) {
                    case "institute":
                        ...
                        $html .= $this->getFieldForMultiSection($field, $fvalue, 3, $sectionid, $jssection_hide,$themecall);
                    break;
                    case "institute_city": 
                        $for = 3;
                        ...
                        if($themecall == null){
                            ...
                            $html .='</label>
                                    <div class="row-value resumefieldvalue">';
                                        ...
                                        $html .= '<input type="text" class="input form-control jsjb-jm-input-field custom_date" name="sec_3[fromdate][]" id="institue_from_date4'.$sectionid.'" value="'.$fieldValue.'">';
                            $html .='</div>
                                </div>';
                        }else{
                            $html .= '<div class="js-col-md-12 js-form-wrapper">
                                        <div class="js-col-md-12 js-form-title jsjb-jm-bigfont" >
                        ...
                        if($themecall == null){
                            ...
                            $html .='</label>
                                    <div class="row-value resumefieldvalue">';
                                        ...
                                        $html .= '<input type="text" class="input form-control jsjb-jm-input-field custom_date" name="sec_3[todate][]" id="institue_to_date4'.$sectionid.'" value="'.$fieldValue.'">';
                            $html .='</div>
                                </div>';
                        }else{
                            $html .= '<div class="js-col-md-12 js-form-wrapper">
        ...
        if($j > 0){
            if(null !=$themecall){
                $html .= '<div class="jsresume_addnewbutton jsjb-jm-resume-addnewbutton" onclick="showResumeSection( this ,\'institute\');">
                <span class="jsjb-jm-addresume-addfield-btn-txt"><i class="fa fa-plus-square-o" aria-hidden="true"></i>'.__('Add New','js-jobs').'&nbsp;'. __('Institute','js-jobs').'
                </span></div>';
            }else{
    ...
    function makeEmployerSectionFields($themecall=null){
                                        ...
                                        case "employer_from_date":
                                            ...
                                            $html .='</label>
                                                    <div class="row-value resumefieldvalue">';
                                                        ...
                                                        $html .= '<input type="text" class="input form-control jsjb-jm-input-field custom_date" name="sec_4[employer_from_date][]" id="employer_from_date4'.$sectionid.'" value="'.$fieldValue.'">';
                                            $html .='</div>
                                                </div>';
                                            break;
                                        case "employer_to_date":
                                            ...
                                            $html .='</label>
                                                    <div class="row-value resumefieldvalue">';
                                                        ...
                                                        $html .= '<input type="text" class="input form-control jsjb-jm-input-field custom_date" name="sec_4[employer_to_date][]" id="employer_to_date4'.$sectionid.'" value="'.$fieldValue.'">';
                                            $html .='</div>
                                                </div>';
                                        break;
                                    }
        ...
        if($j > 0){
            if(null !=$themecall){
                $html .= '<div class="jsresume_addnewbutton jsjb-jm-resume-addnewbutton" onclick="showResumeSection( this ,\'employer\');">
                <span class="jsjb-jm-addresume-addfield-btn-txt"><i class="fa fa-plus-square-o" aria-hidden="true"></i>'.__('Add New','js-jobs').'&nbsp;'. __('Employer','js-jobs').'
                </span></div>';
            }else{
            ...
            //foreach ($fields_ordering as $field) {
                switch ($field->field) {
                    ...
                    case "gender":
                            ...
                            $req = ($field->required ? 'required' : '');
                            $fieldValue = JSJOBSformfield::resumeSelect('gender', JSJOBSincluder::getJSModel('common')->getGender(), $value,'sec_1', __('Select','js-jobs') .'&nbsp;'. __('Gender', 'js-jobs'), array('class' => 'inputbox form-control jsjb-jm-select-field', 'data-validation' => $req));
                    ...
                    case "photo":
                        ...
                        $fieldvalue = '<input style="display:none" type="file" name="photo" class="photo" id="photo" />
                    ...
                    case "resumefiles":
                        ...
                        $fieldvalue = '<input style="display:none;" type="file" id="resumefiles" name="resumefiles[]" data-validation="' . $req . '" multiple="true" />
                        ...
                        $fieldvalue .= '<span class="resume-selectfiles"><img src="' . jsjobs::$_pluginpath . 'includes/images/resume/upload-icon.png" /></span>';
                        $fieldvalue .= '</div>';
                        $data .= $this->getRowForForm($text, $fieldvalue,$themecall);
                    ...
                    case "job_category":
                            ...
                            $req = ($field->required ? 'required' : '');
                            $fieldValue = JSJOBSformfield::resumeSelect('job_category', JSJOBSincluder::getJSModel('category')->getCategoryForCombobox(''),$value,'sec_1', __('Select','js-jobs') , array('class' => 'inputbox  form-control jsjb-jm-select-field', 'data-validation' => $req));
                            $data .= $this->getResumeSelectField($field, $fieldValue,'',$themecall);
                        break;
                    case "jobtype":
                            $value = isset($resume->jobtype) ? $resume->jobtype : JSJOBSincluder::getJSModel('jobtype')->getDefaultJobTypeId();
                            $req = ($field->required ? 'required' : '');
                            $fieldValue = JSJOBSformfield::resumeSelect('jobtype', JSJOBSincluder::getJSModel('jobtype')->getJobTypeForCombo(), $value,'sec_1', __('Select','js-jobs') , array('class' => 'inputbox one  form-control jsjb-jm-select-field', 'data-validation' => $req));
                            $data .= $this->getResumeSelectField($field, $fieldValue,'',$themecall);
                        break;
                    case "nationality":
                            $value = isset($resume->nationalityid) ? $resume->nationalityid : "";
                            $req = ($field->required ? 'required' : '');
                            $fieldValue = JSJOBSformfield::resumeSelect('nationality', JSJOBSincluder::getJSModel('country')->getCountriesForCombo(), $value,'sec_1', __('Select','js-jobs') .'&nbsp;'. __('Nationality', 'js-jobs'), array('class' => 'inputbox  form-control jsjb-jm-select-field', 'data-validation' => $req));;
                            $data .= $this->getResumeSelectField($field, $fieldValue,'',$themecall);
                        break;
                    case "driving_license": 
                            $value = isset($resume->driving_license) ? $resume->driving_license : "";
                            $req = ($field->required ? 'required' : '');
                            $fieldValue = JSJOBSformfield::resumeSelect('driving_license', JSJOBSincluder::getJSModel('common')->getYesNo(), $value,'sec_1', __('Driving License', 'js-jobs'), array('class' => 'inputbox  form-control jsjb-jm-select-field', 'data-validation' => $req));
                            $data .= $this->getResumeSelectField($field, $fieldValue,'',$themecall);
                        break;
                    case "license_no": 
                    ...
                    case "license_country":
                            ...
                            $req = ($field->required ? 'required' : '');
                            $fieldValue = JSJOBSformfield::resumeSelect('license_country', JSJOBSincluder::getJSModel('country')->getCountriesForCombo(), $value,'sec_1', __('License Country', 'js-jobs'), array('class' => 'inputbox  form-control jsjb-jm-select-field', 'data-validation' => $req));
                            $data .= $this->getResumeSelectField($field, $fieldValue,'',$themecall);
                        break;
                    case "heighestfinisheducation":
                            $value = isset($resume->heighestfinisheducation) ? $resume->heighestfinisheducation : "";
                            $req = ($field->required ? 'required' : '');
                            $fieldValue = JSJOBSformfield::resumeSelect('heighestfinisheducation', JSJOBSincluder::getJSModel('highesteducation')->getHighestEducationForCombo(), $value,'sec_1', __('Select','js-jobs') .'&nbsp;'. __('Highest Education', 'js-jobs'), array('class' => 'inputbox  form-control jsjb-jm-select-field', 'data-validation' => $req));
                            $data .= $this->getResumeSelectField($field, $fieldValue,'',$themecall);
                        break;
                    case "total_experience":
                            $value = isset($resume->experienceid) ? $resume->experienceid : "";
                            $req = ($field->required ? 'required' : '');
                            $fieldValue = JSJOBSformfield::resumeSelect('experienceid', JSJOBSincluder::getJSModel('experience')->getExperiencesForCombo(), $value,'sec_1', __('Select','js-jobs') .'&nbsp;'. __('Experience', 'js-jobs'), array('class' => 'inputbox one  form-control jsjb-jm-select-field', 'data-validation' => $req));
                            $data .= $this->getResumeSelectField($field, $fieldValue,'',$themecall);
                        break;
                    case "date_of_birth":
                            $req = ($field->required ? 'required' : '');
                            $fieldValue = isset($resume->date_of_birth) ? date_i18n($js_dateformat,strtotime($resume->date_of_birth)) : '';
                            $data .= $this->getFieldForPersonalSection($field, $fieldValue,0,array('size' => '10', 'maxlength' => '19','data-validation' => $req),$themecall);
                        break;
                    case "date_start":
                            $req = ($field->required ? 'required' : '');
                            $fieldValue = isset($resume->date_start) ? date_i18n($js_dateformat,strtotime($resume->date_start)) : '';
                            $data .= $this->getFieldForPersonalSection($field, $fieldValue,0,array('size' => '10', 'maxlength' => '19','data-validation' => $req),$themecall);
                    ...
                    case "salary":
                            ...
                            $req = ($field->required ? 'required' : '');
                            if(null != $themecall){
                                $data .= '<div class="js-col-md-12 jsjb-jm-field-padding-title">
                                    <div class="js-form-title jsjb-jm-bigfont">' . $field->fieldtitle . '</div>
                                </div>';
                                $data .= '<div class="fullwidthwrapper js-form-wrapper">';
                                    $fieldValue = JSJOBSformfield::resumeSelect('jobsalaryrangestart', JSJOBSincluder::getJSModel('salaryrange')->getJobStartSalaryRangeForCombo(), $rangestart,'sec_1', __('Select','js-jobs') .'&nbsp;'. __('Salary Range','js-jobs') .'&nbsp'. __('Start', 'js-jobs'), array('class' => 'inputbox salarystart  form-control jsjb-jm-select-field', 'data-validation' => $req));
                                    $data .= $this->getResumeSelectField('', $fieldValue,4,$themecall);
                                    $fieldValue = JSJOBSformfield::resumeSelect('jobsalaryrangeend', JSJOBSincluder::getJSModel('salaryrange')->getJobEndSalaryRangeForCombo(), $rangeend,'sec_1', __('Select','js-jobs') .'&nbsp;'. __('Salary Range','js-jobs') .'&nbsp;'. __('End', 'js-jobs'), array('class' => 'inputbox salaryend  form-control jsjb-jm-select-field', 'data-validation' => $req));
                                    $data .= $this->getResumeSelectField('', $fieldValue,4,$themecall);
                                    $fieldValue = JSJOBSformfield::resumeSelect('jobsalaryrangetype', JSJOBSincluder::getJSModel('salaryrangetype')->getSalaryRangeTypesForCombo(), $rangetype,'sec_1', __('Select','js-jobs') .'&nbsp;'. __('Salary Range Type', 'js-jobs'), array('class' => 'inputbox salarytype  form-control jsjb-jm-select-field', 'data-validation' => $req));
                                    $data .= $this->getResumeSelectField('', $fieldValue,4,$themecall);
                                    $fieldValue = JSJOBSformfield::resumeSelect('currencyid', JSJOBSincluder::getJSModel('currency')->getCurrencyForCombo(), $currencyid,'sec_1', __('Select','js-jobs') .'&nbsp;'. __('Currency', 'js-jobs'), array('class' => 'inputbox currency  form-control jsjb-jm-select-field', 'data-validation' => $req));
                                    $data .= $this->getResumeSelectField('', $fieldValue,4,$themecall);
                                $data .='</div>';
                            }else{
                                $fieldValue = JSJOBSformfield::resumeSelect('jobsalaryrangestart', JSJOBSincluder::getJSModel('salaryrange')->getJobStartSalaryRangeForCombo(), $rangestart,'sec_1', __('Select','js-jobs') .'&nbsp;'. __('Salary Range','js-jobs') .'&nbsp'. __('Start', 'js-jobs'), array('class' => 'inputbox salarystart', 'data-validation' => $req));
                    ...
                    case "desired_salary":
                            ...
                            if(null != $themecall){
                                ...
                                $data .= '<div class="fullwidthwrapper js-form-wrapper">';
                                    $fieldValue = JSJOBSformfield::resumeSelect('desiredsalarystart', JSJOBSincluder::getJSModel('salaryrange')->getJobStartSalaryRangeForCombo(), $rangestart,'sec_1', __('Select','js-jobs') .'&nbsp;'. __('Salary Range','js-jobs') .'&nbsp'. __('Start', 'js-jobs'), array('class' => 'inputbox salarystart  form-control jsjb-jm-select-field', 'data-validation' => $req));
                                    $data .= $this->getResumeSelectField('', $fieldValue,4,$themecall);
                                    $fieldValue = JSJOBSformfield::resumeSelect('desiredsalaryend', JSJOBSincluder::getJSModel('salaryrange')->getJobEndSalaryRangeForCombo(), $rangeend,'sec_1', __('Select','js-jobs') .'&nbsp;'. __('Salary Range','js-jobs') .'&nbsp;'. __('End', 'js-jobs'), array('class' => 'inputbox salaryend  form-control jsjb-jm-select-field', 'data-validation' => $req));
                                    $data .= $this->getResumeSelectField('', $fieldValue,4,$themecall);
                                    $fieldValue = JSJOBSformfield::resumeSelect('djobsalaryrangetype', JSJOBSincluder::getJSModel('salaryrangetype')->getSalaryRangeTypesForCombo(), $rangetype,'sec_1', __('Select','js-jobs') .'&nbsp;'. __('Salary Range Type', 'js-jobs'), array('class' => 'inputbox salarytype  form-control jsjb-jm-select-field', 'data-validation' => $req));
                                    $data .= $this->getResumeSelectField('', $fieldValue,4,$themecall);
                                    $fieldValue = JSJOBSformfield::resumeSelect('dcurrencyid', JSJOBSincluder::getJSModel('currency')->getCurrencyForCombo(), $currencyid,'sec_1', __('Select','js-jobs') .'&nbsp;'. __('Currency', 'js-jobs'), array('class' => 'inputbox currency  form-control jsjb-jm-select-field', 'data-validation' => $req));
                                    $data .= $this->getResumeSelectField('', $fieldValue,4,$themecall);
                                $data .='</div>';
                            }else{
                                $fieldValue = JSJOBSformfield::resumeSelect('desiredsalarystart', JSJOBSincluder::getJSModel('salaryrange')->getJobStartSalaryRangeForCombo(), $rangestart,'sec_1', __('Select','js-jobs') .'&nbsp;'. __('Salary Range','js-jobs') .'&nbsp'. __('Start', 'js-jobs'), array('class' => 'inputbox salarystart  form-control jsjb-jm-select-field', 'data-validation' => $req));
                    ...
                    case "video":
                            ...
                            $fieldValue = JSJOBSformfield::resumeSelect('videotype', $videotypeoptions, $value,'sec_1', __('Video Type', 'js-jobs'), array('class' => 'inputbox  form-control jsjb-jm-select-field'));
                            $data .= $this->getResumeSelectField($field,$fieldValue,'',$themecall);
                            
                            $fieldValue = isset($resume->video) ? $resume->video : "";
                            $data .= $this->getFieldForPersonalSection($field, $fieldValue,'','',$themecall);
                        break;
                    case "keywords":
                    ...
                    case 'searchable':
                        ...
                        $req = ''; // for checking field is required or not
                        $req = ($field->required ? 'required' : '');
                        $fieldValue = JSJOBSformfield::resumeSelect('searchable', JSJOBSincluder::getJSModel('common')->getYesNo(), $value,'sec_1', __('Searchable', 'js-jobs'), array('class' => 'inputbox  form-control jsjb-jm-select-field', 'data-validation' => $req));
                        $data .= $this->getResumeSelectField($field,$fieldValue,'',$themecall);
                    break;
                    case 'iamavailable':
                        ...
                        $req = ''; // for checking field is required or not
                        $req = ($field->required ? 'required' : '');
                        $fieldValue = JSJOBSformfield::resumeSelect('iamavailable', JSJOBSincluder::getJSModel('common')->getYesNo(), $value,'sec_1', __('Select','js-jobs') .'&nbsp;'. __('availability', 'js-jobs'), array('class' => 'inputbox form-control jsjb-jm-select-field', 'data-validation' => $req));
                        $data .= $this->getResumeSelectField($field,$fieldValue,'',$themecall);
                        break;
                    default:
    ...
    function printResume($themecall=null) {
        ...
        $html .= '<div class="resume-section-button"><script src="https://www.google.com/recaptcha/api.js" async defer></script>';        
        if(current_user_can('manage_options')){
            ...
            $html .=    $selected.' value="0" '.$two.'>'.__('Pending','js-jobs').'</option>
                        <option '; 
                        $selected = ($status == -1) ? 'selected="selected"' : '';
            $html .=    $selected.' value="-1" '.$two.'>'.__('Reject','js-jobs').'</option>
                    </select></div>
                </div>
                ';
        }
        $isvisitor=false;
        if(isset($_SESSION['jsjobs_apply_visitor'])) $isvisitor=true;
        ...
        if (!is_user_logged_in() && $config_array['resume_captcha'] == 1) {
            $html .= '<div class="resume-row-wrapper form js-col-md-12 js-form-wrapper">
                        <div class="row-title js-col-md-12 js-form-title jsjb-jm-bigfont">' . __('Captcha', 'js-jobs') . '</div>
        ...
        $html .= '<div class="js-col-md-12 js-form-wrapper">
            ...
            if(!is_admin()){ // site 
                $cancel_link=jsjobs::makeUrl(array('jsjobsme'=>'resume', 'jsjobslt'=>'myresumes'));
            }elseif(is_admin()){
                $cancel_link = admin_url("admin.php?page=jsjobs_resume");
            }
            $btn_cancel=false;
            ...
            if ($isvisitor &&  !is_admin()) { 
                    $html .= '<input class="jsjb-jm-btn-primary" type="button" onclick="submitresume();" value="' . __('Apply Now', 'js-jobs') . '"/>';
            } else {
                    $html .= '<input class="jsjb-jm-btn-primary" type="button" onclick="submitresume();" value="' . __('Save', 'js-jobs') . '"/>';
            }
            if($btn_cancel==true)  $html .= '</div>';
            if(!$isvisitor && is_user_logged_in() ){
                if($btn_cancel==true)  $html .= '<div class="js-col-md-6">';
                    $html .= '<a class="resume_submits cancel jsjb-jm-btn-primary" href="'.$cancel_link.'">' . __('Cancel', 'js-jobs') . '</a>';
                if($btn_cancel==true)  {
                        $html .= '</div>';
                }
            }
    ...
    function getRowForForm($text, $value,$themecall=null) {
        if(null != $themecall){
            $html = '<div class="js-col-md-12 js-form-wrapper">
                <div class="js-col-md-12 js-form-title jsjb-jm-bigfont">' . $text . '</div>
