    ...
    if ($data == true) {
        $html = '<div id="js-jobs-widget-wrapper">
					<div class="total-stats-widget-data">
						<img class="total-jobs" src="' . jsjobs::$_pluginpath . '/includes/images/control_panel/latest-icons-admin/top-icons/job.png"/>
					...
					<div class="total-stats-widget-data">
						<img class="total-companies" src="' . jsjobs::$_pluginpath . '/includes/images/control_panel/latest-icons-admin/top-icons/companies.png"/>
						<div class="widget-data-right">
							<div class="data-number">	
					...
					<div class="total-stats-widget-data">
						<img class="total-resumes" src="' . jsjobs::$_pluginpath . '/includes/images/control_panel/latest-icons-admin/top-icons/reume.png"/>
						<div class="widget-data-right">
							<div class="data-number">	
					...
					<div class="total-stats-widget-data">
						<img class="active-jobs" src="' . jsjobs::$_pluginpath . '/includes/images/control_panel/latest-icons-admin/top-icons/active-jobs.png"/>
						<div class="widget-data-right">
							<div class="data-number">	
					...
					<div class="total-stats-widget-data">
						<img class="applied-jobs" src="' . jsjobs::$_pluginpath . '/includes/images/control_panel/latest-icons-admin/top-icons/job-applied.png"/>
						<div class="widget-data-right">
							<div class="data-number">	
    ...
    if ($data == true) {
        $html = '<div id="js-jobs-widget-wrapper">
					...
					<div class="last-week-stats-widget-data" onclick="getWidgetPopup(1)">
						<img class="new-jobs" src="' . jsjobs::$_pluginpath . '/includes/images/control_panel/latest-icons-admin/lower-icons/jobs.png"/>
						<div class="middle-part">
							' . __('New Jobs', 'js-jobs') . '
						<img class="hover-img" src="' . jsjobs::$_pluginpath . '/includes/images/widget-link.png" style="display:none;float:right;"/>
						</div>
					...
					<div class="last-week-stats-widget-data" onclick="getWidgetPopup(2)">
						<img class="new-companies" src="' . jsjobs::$_pluginpath . '/includes/images/control_panel/latest-icons-admin/lower-icons/companies.png"/>
						<div class="middle-part">
					...
					<div class="last-week-stats-widget-data" onclick="getWidgetPopup(3)">
						<img class="new-resumes" src="' . jsjobs::$_pluginpath . '/includes/images/control_panel/latest-icons-admin/lower-icons/reume.png"/>
						<div class="middle-part">
					...
					<div class="last-week-stats-widget-data" onclick="getWidgetPopup(4)">
						<img class="job-applied-new" src="' . jsjobs::$_pluginpath . '/includes/images/control_panel/latest-icons-admin/lower-icons/job-applied.png"/>
						<div class="middle-part">
        ...
        $html .= '<script>
					...
					function getWidgetPopup(popupfor){
						var ajaxurl = "' . $ajaxurl . '";
				        jQuery.post(ajaxurl, {action:"jsjobs_ajax",jsjobsme:"jsjobs",task: "getDataForWidgetPopup",dataid:popupfor},function(data){
				            if(data){
				        	    console.log(data);
