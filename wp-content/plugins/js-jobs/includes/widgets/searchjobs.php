...
class JSJOBSjobssearchjobs_widget extends WP_Widget {
    ...
    public function form($instance) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('title'); ?>"><?php echo __('Title', 'js-jobs'); ?></label> 
            <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr($title); ?>" />
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('showtitle'); ?>"><?php echo __('Show Title', 'js-jobs'); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('jobtitle'); ?>"><?php echo __('Title', 'js-jobs'); ?></label>
            <select class="widefat" id="<?php echo $this->get_field_id('jobtitle'); ?>" name="<?php echo $this->get_field_name('jobtitle'); ?>">
        ...
        <p>
            <label for="<?php echo $this->get_field_id('category'); ?>"><?php echo __('Category', 'js-jobs'); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('jobtype'); ?>"><?php echo __('Job type', 'js-jobs'); ?></label>
            <select class="widefat" id="<?php echo $this->get_field_id('jobtype'); ?>" name="<?php echo $this->get_field_name('jobtype'); ?>">
        ...
        <p>
            <label for="<?php echo $this->get_field_id('jobstatus'); ?>"><?php echo __('Job Status', 'js-jobs'); ?></label>
            <select class="widefat" id="<?php echo $this->get_field_id('jobstatus'); ?>" name="<?php echo $this->get_field_name('jobstatus'); ?>">
        ...
        <p>
            <label for="<?php echo $this->get_field_id('salaryrange'); ?>"><?php echo __('Salary Range', 'js-jobs'); ?></label>
            <select class="widefat" id="<?php echo $this->get_field_id('salaryrange'); ?>" name="<?php echo $this->get_field_name('salaryrange'); ?>">
        ...
        <p>
            <label for="<?php echo $this->get_field_id('shift'); ?>"><?php echo __('Shift', 'js-jobs'); ?></label>
            <select class="widefat" id="<?php echo $this->get_field_id('shift'); ?>" name="<?php echo $this->get_field_name('shift'); ?>">
        ...
        <p>
            <label for="<?php echo $this->get_field_id('duration'); ?>"><?php echo __('Duration', 'js-jobs'); ?></label>
            <select class="widefat" id="<?php echo $this->get_field_id('duration'); ?>" name="<?php echo $this->get_field_name('duration'); ?>">
        ...
        <p>
            <label for="<?php echo $this->get_field_id('company'); ?>"><?php echo __('Company', 'js-jobs'); ?></label>
            <select class="widefat" id="<?php echo $this->get_field_id('company'); ?>" name="<?php echo $this->get_field_name('company'); ?>">
        ...
        <p>
            <label for="<?php echo $this->get_field_id('address'); ?>"><?php echo __('Address', 'js-jobs'); ?></label>
            <select class="widefat" id="<?php echo $this->get_field_id('address'); ?>" name="<?php echo $this->get_field_name('address'); ?>">
        ...
        <p>
            <label for="<?php echo $this->get_field_id('columnperrow'); ?>"><?php echo __('Column per row', 'js-jobs'); ?></label> 
            <input class="widefat" id="<?php echo $this->get_field_id('columnperrow'); ?>" name="<?php echo $this->get_field_name('columnperrow'); ?>" type="text" value="<?php echo esc_attr($columnperrow); ?>" />
        </p>
        <?php
    }
    ...
    public function update($new_instance, $old_instance) {
        ...
        $instance['jobtitle'] = (!empty($new_instance['jobtitle'])) ? strip_tags($new_instance['jobtitle']) : '';
        $instance['category'] = (!empty($new_instance['category'])) ? strip_tags($new_instance['category']) : '';

        $instance['jobtype'] = (!empty($new_instance['jobtype'])) ? strip_tags($new_instance['jobtype']) : '';
        $instance['jobstatus'] = (!empty($new_instance['jobstatus'])) ? strip_tags($new_instance['jobstatus']) : '';
        $instance['salaryrange'] = (!empty($new_instance['salaryrange'])) ? strip_tags($new_instance['salaryrange']) : '';
        $instance['shift'] = (!empty($new_instance['shift'])) ? strip_tags($new_instance['shift']) : '';
        ...
        $instance['columnperrow'] = (!empty($new_instance['columnperrow'])) ? strip_tags($new_instance['columnperrow']) : '';
