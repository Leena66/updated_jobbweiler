...
if ($menu == 'employer') {
    if (is_user_logged_in()) { // Login user
        if ($config_array['tmenu_emcontrolpanel'] == 1) {
            $linkarray[] = array(
                'link' => jsjobs::makeUrl(array('jsjobsme'=>'employer', 'jsjobslt'=>'controlpanel')),
        ...
        if ($config_array['tmenu_emmyjobs'] == 1) {
            $linkarray[] = array(
                'link' => jsjobs::makeUrl(array('jsjobsme'=>'job', 'jsjobslt'=>'myjobs')),
                'title' => __('My Jobs', 'js-jobs'),
            );
        }
        if ($config_array['tmenu_emmycompanies'] == 1) {
            $linkarray[] = array(
                'link' => jsjobs::makeUrl(array('jsjobsme'=>'company', 'jsjobslt'=>'mycompanies')),
                'title' => __('My Companies', 'js-jobs'),
            );
        }
        if ($config_array['tmenu_emsearchresume'] == 1) {
            $linkarray[] = array(
                'link' => jsjobs::makeUrl(array('jsjobsme'=>'resumesearch', 'jsjobslt'=>'resumesearch')),
    ...
    if (is_user_logged_in()) {
        if ($config_array['tmenu_jscontrolpanel'] == 1) {
            $linkarray[] = array(
                'link' => jsjobs::makeUrl(array('jsjobsme'=>'jobseeker', 'jsjobslt'=>'controlpanel')),
                'title' => __('Control Panel', 'js-jobs'),
            );
        }
        if ($config_array['tmenu_jsjobcategory'] == 1) {
            $linkarray[] = array(
                'link' => jsjobs::makeUrl(array('jsjobsme'=>'job', 'jsjobslt'=>'jobsbycategories')),
                'title' => __('Jobs By Categories', 'js-jobs'),
            );
        }
        if ($config_array['tmenu_jssearchjob'] == 1) {
            $linkarray[] = array(
                'link' => jsjobs::makeUrl(array('jsjobsme'=>'jobsearch', 'jsjobslt'=>'jobsearch')),
        ...
        if ($config_array['tmenu_jsmyresume'] == 1) {
            $linkarray[] = array(
                'link' => jsjobs::makeUrl(array('jsjobsme'=>'resume', 'jsjobslt'=>'myresumes')),
