...
function jsjb_parse_request($q) {
    ...
    if(isset($q->query_vars['jsjblayout']) && !empty($q->query_vars['jsjblayout'])){
        ...
        switch ($layout) {
            ...
            $jsjb1 = str_replace('/', '',$q->query_vars['jsjb1']);
            if(!empty($jsjb1)){
            ...
            $jsjb2 = str_replace('/', '',$q->query_vars['jsjb2']);
            if(!empty($jsjb2)){
            ...
            jsjobs::$_data['sanitized_args']['jsjobsid'] = str_replace('/', '',$q->query_vars['jsjb1']);
            break;
            case 'cover-letter':
            ...
            $jsjb2 = str_replace('/', '',$q->query_vars['jsjb2']);
                //var_dump($jsjb2);
            if(!empty($jsjb2)){
                if(strstr($jsjb2, 'sortby')){
                    jsjobs::$_data['sanitized_args']['sortby'] = $jsjb2;
                }else{
                    jsjobs::$_data['sanitized_args']['ta'] = $jsjb2;
                }
            }
            $jsjb3 = str_replace('/', '',$q->query_vars['jsjb3']);
            if(!empty($jsjb3)){
        ...
        //echo '<pre>';print_r(jsjobs::$_data['sanitized_args']);exit;
        /*
        switch ($layout) {
            case 'new-in-jsjobs':
            jsjobs::$_data['sanitized_args']['jsjobsme'] = 'common';
