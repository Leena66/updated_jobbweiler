...
class JSJOBSJobapplyModel {
    ...
    function setResumeRatting(){
        $jobapplyid = (int) JSJOBSrequest::getVar('jobapplyid');
        $rate = (int) JSJOBSrequest::getVar('rate');
        ...
        if($row->load($jobapplyid)){
            $row->columns['rating'] = $rate;
            if(!$row->store()){
                return false;
            }
        }else{
    ...
    function getResumeDetail($themecall=null) {
        ...
        $html = '';
        $html.='<img id="close-section" onclick="closeSection()" src="' . jsjobs::$_pluginpath . 'includes/images/no.png"/>';
    ...
    function getJobApplyHtmlForJobManager($jobid){
        ...
        if ($jobid && is_numeric($jobid)) {
                ...
                $content = '<div class="modal-content jsjb-jm-modal-wrp">';
                $content .= '<div class="jsjb-jm-modal-left-image-wrp">
                            <i class="fa fa-paper-plane jsjb-jm-modal-left-image" aria-hidden="true"></i>
                        </div>    
                        <div class="jsjb-jm-modal-header">
                            <a title="close" class="close jsjb-jm-modal-close-icon-wrap" href="#" onclick="jsjobsClosePopup(1);" >
                                <img id="popup_cross" src="'.jsjobs::$_pluginpath.'includes/images/popup-close.png">
                            </a>
                            <h3 class="jsjb-jm-modal-title">'.__("Apply Now", "js-jobs").'</h3>
                        </div>';
                $content .= '<div class="col-md-12 jsjb-jm-modal-job-title-wrp">
                            <div class="col-md-11 col-md-offset-1 jsjb-jm-modal-job-title">
                                <h5 class="jsjb-jm-modal-job-title-txt">'.$jobtitle.'</h5>
                            </div>
                        </div>';
                $content .= '<div class="col-md-11 col-md-offset-1 jsjb-jm-modal-data-wrp">';
                $content .= '<div class="modal-body jsjb-jm-modal-body">';
                $content .= '<div class="form jsjb-jm-modal-form-wrp">';
                ...
                if (!JSJOBSincluder::getObjectClass('user')->isguest()) {
                    ...
                    if (is_numeric($uid) && $uid != 0 && $isjobseeker == true) {
                        $query = "SELECT id,application_title AS text FROM `" . jsjobs::$_db->prefix . "js_job_resume` WHERE status = 1 AND uid = " . $uid;
                    ...
                    if ($resumelist != null && $isjobseeker == true) {
                        $content .= '<div class="col-md-12 jsjb-jm-modal-form-row">';
                        $content .= '<div class="col-md-6 jsjb-jm-modal-form-inpf-l">';
                        ...
                        $content .= '</div>';
                        $content .= '</div>';
                        $content .= '<div class="col-md-6 jsjb-jm-modal-form-inpf-r">';
                        $content .= '<div class="form-group">';
                        ...
                        $class1 = '';
                        $class2 = 'jsjb-jm-btn-primary';
                    } else {
                        $showlink = false;
                        if ($isjobseeker == true) {
                            $content .= '<div class="jsjb-jm-popup-row-msg">';
                            $content .= '<span class="visitor-message"><img src="' . jsjobs::$_pluginpath . 'includes/images/not-loggedin.png" />' . __('You do not have any resume!', 'js-jobs') . '</span>';
                            $content .= '</div>';
                            $content .= '   <div class="quickviewbutton">
                            <a class="jsjb-jm-btn-primary" href="'.jsjobs::makeUrl(array('jsjobsme'=>'resume', 'jsjobslt'=>'addresume', 'jsjobspageid'=>JSJOBSrequest::getVar('jsjobs_pageid'))).'" > ' . __('Add Resume', 'js-jobs') . '</a>
                        </div>';
                        } elseif($isemployer == true) {
                            $content .= '<div class="jsjb-jm-popup-row-msg">';
                            $content .= '<span class="visitor-message"><img src="' . jsjobs::$_pluginpath . 'includes/images/not-loggedin.png" />' . __('You are employer, you can not apply to job', 'js-jobs') . '!</span>';
                            $content .= '</div>';
                        } else {
                            $content .= '<div class="jsjb-jm-popup-row-msg">';
                            $content .= '<span class="visitor-message"><img src="' . jsjobs::$_pluginpath . 'includes/images/not-loggedin.png" />' . __('You do not have any role', 'js-jobs') . '!</span>';
                            $content .= '</div>';
                        }
                    }
                } else {
                    $content .= '<div class="jsjb-jm-popup-row-msg">';
                    $content .= '<span class="jsjb-jm-popup-row-txt"><img src="' . jsjobs::$_pluginpath . 'includes/images/not-loggedin.png" />' . __('You are not a logged in member, please select below option to apply on job.', 'js-jobs') . '</span>';
                    $content .= '</div>';
                    ...
                    $class1 = 'login jsjb-jm-btn-secondary';
                    $class2 = 'applyvisitor jsjb-jm-btn-primary';
                }
                $visitor_can_apply_to_job = JSJOBSincluder::getJSModel('configuration')->getConfigurationByConfigName('visitor_can_apply_to_job');
                $content .= '<div class="col-md-12 jsjb-jm-modal-form-btn">';
                if ($showlink == true) {
                    $full=true;
                    $content .= '   <div class="form-group">';
                    if(isset($link2) && $link2!=""){
                        $full=false;
                        $content .= '<div class="col-md-6 jsjb-jm-modal-form-inpf-l">';
                            $content .='<a ' . $link2 . ' class="jsjb-jm-modal-form-btn-inpf ' . $class1 . '" >' . $text2 . '</a>';
                        $content .= '</div>';
                    }
                    if($visitor_can_apply_to_job == 1 || $isjobseeker == true){
                        if($full===false) $content .= '<div class="col-md-6 jsjb-jm-modal-form-inpf-l">';

                            $content .= '<a ' . $link1 . ' class="jsjb-jm-modal-form-btn-inpf ' . $class2 . '" id="apply-now-btn" >' . $text1 . '</a>';
                ...
                if ($config_array['applywithfacebook'] == 1 || $config_array['applywithlinkedin'] == 1 || $config_array['applywithxing'] == 1) {
                    if ($isemployer != true) {                        
                        $content .= '   <div class="jsjb-jm-social-btn-wrp">';
                    ...
                    if ($config_array['applywithfacebook'] == 1) {
                                    //$content .= '<a href="'.jsjobs::makeUrl(array('jsjobsme'=>'jobapply', 'action'=>'jsjobtask', 'task'=>'jobapplysocial', 'media'=>'facebook', 'jobid'=>$jobid. 'jsnext'=>$jsnext)) . '" class="sc fb"><img src="' . jsjobs::$_pluginpath . 'includes/images/scico/fb.png" />' . __('Apply with facebook','js-jobs') . '</a>';
                        $content .= '<a class="jsjb-jm-social-btn" href="'.jsjobs::makeUrl(array('jsjobsme'=>'jobapply', 'action'=>'jsjobtask', 'task'=>'jobapplysocial', 'media'=>'facebook', 'jobid'=>$jobid, 'jsnext'=>$jsnext)) . '" class="sc fb" ><img src="' . jsjobs::$_pluginpath . 'includes/images/scico/fb.png" />' . __('Apply with facebook','js-jobs') . '</a>';
                    }
                    if ($config_array['applywithlinkedin'] == 1) {
                        $content .= '<a class="jsjb-jm-social-btn" href="'.jsjobs::makeUrl(array('jsjobsme'=>'jobapply', 'action'=>'jsjobtask', 'task'=>'jobapplysocial', 'media'=>'linkedin', 'jobid'=>$jobid, 'jsnext'=>$jsnext)) . '" class="sc linkedin" ><img class="js-linkd" src="' . jsjobs::$_pluginpath . 'includes/images/scico/in.png" />' . __('Apply with linkedin','js-jobs') . '</a>';
                    }
                    if ($config_array['applywithxing'] == 1) {
                        $content .= '<a class="jsjb-jm-social-btn" href="'.jsjobs::makeUrl(array('jsjobsme'=>'jobapply', 'action'=>'jsjobtask', 'task'=>'jobapplysocial', 'media'=>'xing', 'jobid'=>$jobid, 'jsnext'=>$jsnext)). '" class="sc xing" ><img src="' . jsjobs::$_pluginpath . 'includes/images/scico/xing.png" />' . __('Apply with xing','js-jobs') . '</a>';
                    }
                    $content .= '   </div>';
                }
            }
            ...
            $content .= '<div class="col-md-12 jsjb-jm-modal-job-title-wrp">
                        <div class="col-md-11 col-md-offset-1 jsjb-jm-modal-job-title">
                            <h1 class="jsjb-jm-modal-job-title-txt">'.$title.'</h1>
                        </div>
                    </div>
                    </div>';
        }
    ...
    function getJobApplyDetailByid(){
        ...
        if ($id && is_numeric($id)) {
            $query = "SELECT resume.id AS resumeid
                    ,resume.application_title,coverletter.title AS coverlettertitle,coverletter.id AS coverletterid
                    ,jobapply.id AS id
            ...
            if($result){
                $content .='<div class="modal-content jsjb-jm-modal-wrp">
                                <div class="jsjb-jm-modal-header">
                                    ...
                                    <h2 class="jsjb-jm-modal-title">'.__("Applied Info","job-manager").'</h2>
                                </div>
                                <div class="col-md-12 jsjb-jm-appliedinformation-modal-data-wrp">
                                    <div class="modal-body jsjb-jm-modal-body">
                                       <div class="jsjb-jm-appliedinformation-title">

                                       <h5 class="jsjb-jm-appliedinformation-title-txt">
                                       ...
                                       <div class="jsjb-jm-appliedinformation-value">
                ...
                $content .='<div class="modal-content jsjb-jm-modal-wrp">
                    <div class="jsjb-jm-modal-header">
                        <a title="close" class="close jsjb-jm-modal-close-icon-wrap" href="#" onclick="jsjobsClosePopup(1);" >
                            <img id="popup_cross" src="'.jsjobs::$_pluginpath.'includes/images/popup-close.png">
                        </a><h2 class="jsjb-jm-modal-title">'.__("Applied Info","job-manager").'</h2></div>
                        <div class="col-md-12 jsjb-jm-appliedinformation-modal-data-wrp">
                            <h3 class="jsjb-jm-modal-title">'.__("No Record Found","job-manager").'</h3>
                        </div>
                        </div>';                                
            }
        }else{
            ...
            <div class="jsjb-jm-modal-header">
                ...
                <div class="col-md-12 jsjb-jm-appliedinformation-modal-data-wrp">
                    <h3 class="jsjb-jm-modal-title">'.__("Something wrong pleas try later","job-manager").'</h3>
                </div>
                </div>';                
        }
                ...
                if (!JSJOBSincluder::getObjectClass('user')->isguest()) {
                    ...
                    if ($resumelist != null && $isjobseeker == true) {
                        ...
                        if ($isjobseeker == true) {
                            ...
                            $content .= '</div>';
                            $content .= '   <div class="quickviewbutton">
                                                <a href="'.jsjobs::makeUrl(array('jsjobsme'=>'resume', 'jsjobslt'=>'addresume', 'jsjobspageid'=>JSJOBSrequest::getVar('jsjobs_pageid'))).'" class="resumeaddlink"> <img src="' . jsjobs::$_pluginpath .'includes/images/add-circle.png" />' . __('Add Resume', 'js-jobs') . '</a>
                                            </div>';
                        } elseif($isemployer == true) {
                            $content .= '<div class="quickviewrow">';
                            $content .= '<span class="visitor-message"><img src="' . jsjobs::$_pluginpath . 'includes/images/not-loggedin.png" />' . __('You are employer, you can not apply to job', 'js-jobs') . '!</span>';
                    ...
                    $content .= '<div class="quickviewrow">';
                    $content .= '<span class="visitor-message"><img src="' . jsjobs::$_pluginpath . 'includes/images/not-loggedin.png" />' . __('You are not a logged in member, please select below option to apply on job.', 'js-jobs') . '</span>';
                    $content .= '</div>';
    ...
    function jobapplyjobmanager(){
        ...
        if($return_val===1){
            $msg = '<div id="jsjb-jm-notification-not-ok"><div id="popup_message">
            <img src="' . jsjobs::$_pluginpath . 'includes/images/unpublish.png"/><spam class="popup_msg_txt">' . __("please select a resume first", "js-jobs") . '</spam><button class="applynow-closebutton" onclick="jsjobsClosePopup(1);" ><img src="'.jsjobs::$_pluginpath.'/includes/images/popupcloseicon.png"/>'.__('Close','js-jobs').'</button></div></div>';
        }elseif($return_val === 2) {
            $msg = '<div id="jsjb-jm-notification-ok"><div id="popup_message">
            <img src="' . jsjobs::$_pluginpath . 'includes/images/approve.png"/><spam class="popup_msg_txt">' . __("You have already applied this job", "js-jobs") . '</spam><button class="applynow-closebutton" onclick="jsjobsClosePopup(1);" ><img src="'.jsjobs::$_pluginpath.'/includes/images/popupcloseicon.png"/>'.__('Close','js-jobs').'</button></div></div>';
        }elseif($return_val == SAVE_ERROR) {
            $msg = '<div id="jsjb-jm-notification-not-ok"><div id="popup_message">
            <img src="' . jsjobs::$_pluginpath . 'includes/images/unpublish.png"/><spam class="popup_msg_txt">' . __("Failed while performing this action", "js-jobs") . '</spam><button class="applynow-closebutton" onclick="jsjobsClosePopup(1);" ><img src="'.jsjobs::$_pluginpath.'/includes/images/popupcloseicon.png"/>'.__('Close','js-jobs').'</button></div></div>';
        }elseif($return_val == SAVED) {
            $msg = '<div id="jsjb-jm-notification-ok"><div id="popup_message">
            <img src="' . jsjobs::$_pluginpath . 'includes/images/approve.png"/><spam class="popup_msg_txt">' . __("Job has been applied", "js-jobs") . '</spam><button class="applynow-closebutton" onclick="jsjobsClosePopup(1);" ><img src="'.jsjobs::$_pluginpath.'/includes/images/popupcloseicon.png"/>'.__('Close','js-jobs').'</button></div></div>';
        }
        return $msg;
    }
    ...
    function jobapply($themecall=null) {
        ...
        if (! is_numeric($cvid)) {
            ...
            $msg = '<div id="notification-not-ok"><label id="popup_message"><img src="' . jsjobs::$_pluginpath . 'includes/images/unpublish.png"/>' . __("please select a resume first", "js-jobs") . '</label><button class="applynow-closebutton" onclick="closePopup();" ><img src="'.jsjobs::$_pluginpath.'/includes/images/popupcloseicon.png"/>'.__('Close','js-jobs').'</button></div>';
            return $msg;
        }
        ...
        if ($alreadycheck == false) {
            ...
            $msg = '<div id="notification-ok"><label id="popup_message"><img src="' . jsjobs::$_pluginpath . 'includes/images/approve.png"/>' . __("You have already applied this job", "js-jobs") . '</label><button class="applynow-closebutton" onclick="closePopup();" ><img src="'.jsjobs::$_pluginpath.'/includes/images/popupcloseicon.png"/>'.__('Close','js-jobs').'</button></div>';
            return $msg;
        }
        $return = SAVED;
        if (!$row->bind($data)) {
        ...
        if ($return != SAVE_ERROR) {

            $this->sendMail($jobid,$cvid);

            $msg = '<div id="notification-ok"><label id="popup_message"><img src="' . jsjobs::$_pluginpath . 'includes/images/approve.png"/>' . __("Job has been applied", "js-jobs") . '</label><button class="applynow-closebutton" onclick="closePopup();" ><img src="'.jsjobs::$_pluginpath.'/includes/images/popupcloseicon.png"/>'.__('Close','js-jobs').'</button></div>';
            $uid = JSJOBSincluder::getJSModel('common')->getUidByObjectId('job', $row->jobid);
            //notification for employer
        } else {
            $msg = '<div id="notification-not-ok"><label id="popup_message"><img src="' . jsjobs::$_pluginpath . 'includes/images/unpublish.png"/>' . __("Failed while performing this action", "js-jobs") . '</label><button class="applynow-closebutton" onclick="closePopup();" ><img src="'.jsjobs::$_pluginpath.'/includes/images/popupcloseicon.png"/>'.__('Close','js-jobs').'</button></div>';
        }
...
//MAIL TO ADMIN ON JOBAPPLY
        ...
        $msgBody = str_replace('{COVER_LETTER_TITLE}',$coverlettertitle, $msgBody);
        $msgBody = str_replace('{COVER_LETTER_DESCRIPTION}', $coverletterdescription, $msgBody);            
    ...
    function getEmailFieldsJobManager(){
        ...
        $html = '<div class="jsjb-jm-sendemail-form">
                    <form class="">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4 jsjb-jm-ar-se">
                            <div class="form-group">
                                <textarea id="email-body" placeholder="' . __('Type here', 'job-manager') . '" class="form-control note-txt" rows="8"></textarea>
                            </div>
                        </div>
                        <div class="col-md-4 jsjb-jm-sendemail-btn-wrp">
                            <div class="form-group jsjb-jm-sendemail-btn-data">
                                <input type="button" class="form-control jsjb-jm-sendemail-btn" value="' . __('Send', 'job-manager') . '" onclick="sendEmail('.$resumeid.')">
                                <input type="button" class="form-control jsjb-jm-sendemail-btn" onclick="closeSection()" value="' . __('Cancel', 'job-manager') . '">
                            </div>
                        </div>
                    </form>
                </div>';
    ...
    function visitorapplyjob(){
        $resumeid = $_SESSION['wp-jsjobs']['resumeid'];
        $jobid = $_SESSION['jsjobs_apply_visitor'];
        $result = $this->jobapplyVisitor($resumeid, $jobid);
        if($result){
            $msg = JSJOBSMessages::getMessage(APPLY,'job');
        }else{
            $msg = JSJOBSMessages::getMessage(APPLY_ERROR,'job');
        }
    ...
    function getMessagekey(){
        $key = 'jobapply';if(is_admin()){$key = 'admin_'.$key;}return $key;
    }
