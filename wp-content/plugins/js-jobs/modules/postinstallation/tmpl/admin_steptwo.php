    ...
    <div class="post-installtion-content">
        <form id="jsjobs-form-ins" method="post" action="<?php echo admin_url("admin.php?page=jsjobs_postinstallation&task=save&action=jsjobtask"); ?>">
            <div class="pic-config">
                ...
                <div class="field"> 
                    <?php echo JSJOBSformfield::select('disable_employer', $yesno,jsjobs::$_data[0]['disable_employer'],'',array('class' => 'inputbox')); ?>
                </div>
            ...
            <div class="pic-config">
                ...
                <div class="field"> 
                    <?php echo JSJOBSformfield::select('showemployerlink', $yesno,jsjobs::$_data[0]['showemployerlink'],'',array('class' => 'inputbox')); ?>
                </div>
            ...
            <div class="pic-config">
                ...
                <div class="field"> 
                    <?php echo JSJOBSformfield::select('employer_defaultgroup', $userroles,jsjobs::$_data[0]['employer_defaultgroup'],'',array('class' => 'inputbox')); ?>
                </div>
            ...
            <div class="pic-config">
                ...
                <div class="field"> 
                    <?php echo JSJOBSformfield::select('employerview_js_controlpanel', $yesno,jsjobs::$_data[0]['employerview_js_controlpanel'],'',array('class' => 'inputbox')); ?>
                </div>
            </div>
            <div class="pic-config">
                <div class="title"> 
                ...
                <div class="field"> 
                    <?php echo JSJOBSformfield::select('companyautoapprove', $yesno,jsjobs::$_data[0]['companyautoapprove'],'',array('class' => 'inputbox')); ?>
                </div>
            </div>
            <div class="pic-config">
                <div class="title"> 
                ...
                <div class="field"> 
                    <?php echo JSJOBSformfield::select('jobautoapprove', $yesno,jsjobs::$_data[0]['jobautoapprove'],'',array('class' => 'inputbox')); ?>
                </div>
            </div>
            <div class="pic-button-part">
                <a class="next-step" href="#"  onclick="document.getElementById('jsjobs-form-ins').submit();" >
                    ...
                    <img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/postinstallation/next-arrow.png" />
                </a>
                <a class="back" href="<?php echo admin_url('admin.php?page=jsjobs_postinstallation&jsjobslt=stepone'); ?>"> 
            ...
            <?php echo JSJOBSformfield::hidden('step', 2); ?>
        </form>
    </div>
