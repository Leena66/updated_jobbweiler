...
<div id="jsjobsadmin-wrapper" class="post-installation">
    ...
    <div class="post-installtion-content">
        <form id="jsjobs-form-ins" method="post" action="<?php echo admin_url("admin.php?page=jsjobs_postinstallation&task=save&action=jsjobtask"); ?>">
            <div class="pic-config">
                <div class="title"> 
                    <?php echo __('Title','js-jobs');?>: &nbsp;
                </div>
                <div class="field"> 
                    <?php echo JSJOBSformfield::text('title',jsjobs::$_data[0]['title'], array('class' => 'inputbox')); ?>
                </div>
                <div class="desc"> </div>
            </div>
            <div class="pic-config">
                ...
                <div class="field"> 
                    <?php echo JSJOBSformfield::text('system_slug',jsjobs::$_data[0]['system_slug'], array('class' => 'inputbox')); ?>
                </div>
            </div>
            <div class="pic-config">
                <div class="title"> 
                ...
                <div class="field"> 
                    <?php echo JSJOBSformfield::select('default_pageid', JSJOBSincluder::getJSModel('postinstallation')->getPageList(),jsjobs::$_data[0]['default_pageid'],'',array('class' => 'inputbox')); ?>
                </div>
            ...
            <div class="pic-config">
                ...
                <div class="field"> 
                    <?php echo JSJOBSformfield::text('data_directory',jsjobs::$_data[0]['data_directory'], array('class' => 'inputbox')); ?>
                </div>
                <div class="desc"><?php echo __('System will upload all user files in this folder','js-jobs');?> </div>
                <div class="desc"><?php echo jsjobs::$_path.jsjobs::$_data[0]['data_directory'];?> </div>
            </div>
            <div class="pic-config">
                <div class="title"> 
                ...
                <div class="field"> 
                    <?php echo JSJOBSformfield::text('adminemailaddress',jsjobs::$_data[0]['adminemailaddress'], array('class' => 'inputbox')); ?>
                </div>
            ...
            <div class="pic-config">
                ...
                <div class="field"> 
                    <?php echo JSJOBSformfield::text('mailfromaddress',jsjobs::$_data[0]['mailfromaddress'], array('class' => 'inputbox')); ?>
                </div>
            ...
            <div class="pic-config">
                ...
                <div class="field"> 
                    <?php echo JSJOBSformfield::text('mailfromname',jsjobs::$_data[0]['mailfromname'], array('class' => 'inputbox')); ?>
                </div>
            ...
            <div class="pic-config">
                ...
                <div class="field"> 
                    <?php echo JSJOBSformfield::select('cur_location', $yesno,jsjobs::$_data[0]['cur_location'],'',array('class' => 'inputbox')); ?>
                </div>
            ...
            <div class="pic-config">
                ...
                <div class="field"> 
                    <?php echo JSJOBSformfield::select('date_format', $date_format,jsjobs::$_data[0]['date_format'],'',array('class' => 'inputbox')); ?>
                </div>
            ...
            <div class="pic-button-part">
                <a class="next-step full-width" href="#" onclick="document.getElementById('jsjobs-form-ins').submit();" >
                    ...
                    <img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/postinstallation/arrow.png" />
                </a>
            </div>
            <?php echo JSJOBSformfield::hidden('action', 'postinstallation_save'); ?>
            <?php echo JSJOBSformfield::hidden('form_request', 'jsjobs'); ?>
            <?php echo JSJOBSformfield::hidden('step', 1); ?>
        </form>
    </div>
