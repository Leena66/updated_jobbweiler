...
<script type="text/javascript">
    ...
    if (typeof(donutchart) != 'undefined' && donutchart != null){
        google.setOnLoadCallback(drawChart_pir);
    }
    //for notifications
    ...
    function drawChart_pir() {
        var data = google.visualization.arrayToDataTable([
            <?php
            if (isset(jsjobs::$_data['stack_chart_horizontal1']) && is_array(jsjobs::$_data['stack_chart_horizontal1'])) {
                echo jsjobs::$_data['stack_chart_horizontal1']['title'] . ',';
                echo jsjobs::$_data['stack_chart_horizontal1']['data'];
            }
            ?>
            ]);
        var options = {
            title: '<?php if (isset(jsjobs::$_data["graph1"])) echo jsjobs::$_data["graph1"]["title"]; ?>',
            pieHole: 0.4,
    ...
    function drawChart() {
        var data = google.visualization.arrayToDataTable([
            <?php
            $stack_chart_horizontal_title="";
            if(isset(jsjobs::$_data['stack_chart_horizontal']['title'])){
                $stack_chart_horizontal_title=jsjobs::$_data['stack_chart_horizontal']['title'];
            }
            $stack_chart_horizontal_data="";
            if(isset(jsjobs::$_data['stack_chart_horizontal']['data'])){
                $stack_chart_horizontal_data=jsjobs::$_data['stack_chart_horizontal']['data'];

            }
            echo $stack_chart_horizontal_title . ',';
            echo $stack_chart_horizontal_data;
            ?>
            ]);
        var options = {
            title: '<?php echo (isset(jsjobs::$_data["graph"]["title"]))?jsjobs::$_data["graph"]["title"]:""; ?>'
            , pointSize: 6
