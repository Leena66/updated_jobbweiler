...
<div id="jsjobsadmin-wrapper">
    ...
    <span class="js-admin-title">
        ...
        ?>
        <a class="js-button-link button" href="<?php echo admin_url('admin.php?page=jsjobs_careerlevel&jsjobslt=formcareerlevels'); ?>"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/add_icon.png" /><?php echo __('Add New','js-jobs') .'&nbsp;'. __('Career Level', 'js-jobs') ?></a>
    </span>
    ...
    <form class="js-filter-form" name="jsjobsform" id="jsjobsform" method="post" action="<?php echo admin_url("admin.php?page=jsjobs_careerlevel"); ?>">
    ...
    if (!empty(jsjobs::$_data[0])) {
        ?>
        <form id="jsjobs-list-form" method="post" action="<?php echo admin_url("admin.php?page=jsjobs_careerlevel"); ?>">
            <table id="js-table">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    for ($i = 0, $n = count(jsjobs::$_data[0]); $i < $n; $i++) {
                        ...
                        <tr valign="top">
                            ...
                            <td class="left-row">
                                <a href="<?php echo admin_url('admin.php?page=jsjobs_careerlevel&jsjobslt=formcareerlevels&jsjobsid='.$row->id); ?>"><?php echo __($row->title,'js-jobs'); ?></a>
                            </td>
                            <td>
                                <?php if ($row->isdefault == 1) { ?> 
                                    <img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/default.png" alt="Default" border="0" />
                                   <?php } else { ?>
                                    <a href="<?php echo admin_url('admin.php?page=jsjobs_common&task=makedefault&action=jsjobtask&for=careerlevels&id='.$row->id.$pageid); ?>">
                                        <img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/notdefault.png" border="0" alt="Not Default" /></a>
                                <?php } ?>	
                            </td>	
                            <td>
                                <?php if ($row->status == 1) { ?> 
                                    <a href="<?php echo admin_url('admin.php?page=jsjobs_careerlevel&task=unpublish&action=jsjobtask&jsjobs-cb[]='.$row->id.$pageid); ?>">
                                        <img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/yes.png" border="0" alt="<?php echo __('Published', 'js-jobs'); ?>" />
                                    </a>
                                <?php } else { ?>
                                    <a href="<?php echo admin_url('admin.php?page=jsjobs_careerlevel&task=publish&action=jsjobtask&jsjobs-cb[]='.$row->id.$pageid); ?>">
                            ...
                            <td>
                                <?php if ($i != 0 || $pagenum > 1) { ?>		
                                    <a href="<?php echo admin_url('admin.php?page=jsjobs_common&task=defaultorderingup&action=jsjobtask&for=careerlevels&id='.$row->id.$pageid); ?>">
                                        <img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/<?php echo $upimg; ?>" border="0" alt="Order Up" />
                                    </a>
                                <?php } else echo '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'; ?>	
                                <?php echo $row->ordering; ?>
                                <?php if ($i < $n - 1 || $islastordershow) { ?>
                                    <a href="<?php echo admin_url('admin.php?page=jsjobs_common&task=defaultorderingdown&action=jsjobtask&for=careerlevels&id='.$row->id.$pageid); ?>">
                                        <img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/<?php echo $downimg; ?>" border="0" alt="Order Down" />
                                    </a>
                                <?php } ?>
                            </td>
                            <td class="action">
                                <a href="<?php echo admin_url('admin.php?page=jsjobs_careerlevel&jsjobslt=formcareerlevels&jsjobsid='.$row->id); ?>"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/edit.png" title="<?php echo __('Edit', 'js-jobs'); ?>"></a>
                                <a href="<?php echo admin_url('admin.php?page=jsjobs_careerlevel&task=remove&action=jsjobtask&jsjobs-cb[]='.$row->id); ?>" onclick="return confirmdelete('<?php echo __('Are you sure to delete', 'js-jobs').' ?'; ?>');"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/remove.png" title="<?php echo __('Delete', 'js-jobs'); ?>"></a>
                            </td>
                        </tr>
                <?php
                    }
            ...
            <?php echo JSJOBSformfield::hidden('action', 'careerlevel_remove'); ?>
        ...
        $link[] = array(
                    'link' => 'admin.php?page=jsjobs_careerlevel&jsjobslt=formcareerlevels',
