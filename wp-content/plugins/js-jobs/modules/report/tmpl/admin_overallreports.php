...
<div id="jsjobsadmin-wrapper">
    ...
    <div id="charts">
        ...
        <div class="boxeswrapper">
            <div class="box">
                <img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/report/job.png" />
                <span class="number"><?php echo jsjobs::$_data['totaljobs']; ?></span>
                <span class="desc"><?php echo __('Total jobs', 'js-jobs'); ?></span>
            </div>
            <div class="box">
                <img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/report/resume.png" />
                <span class="number"><?php echo jsjobs::$_data['totalresume']; ?></span>
                <span class="desc"><?php echo __('Total resume', 'js-jobs'); ?></span>				
            </div>
            <div class="box">
                <img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/report/company.png" />
                <span class="number"><?php echo jsjobs::$_data['totalcompany']; ?></span>
                <span class="desc"><?php echo __('Total companies', 'js-jobs'); ?></span>				
            </div>
            <div class="box">
                <img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/report/appliedresume.png" />
                <span class="number"><?php echo jsjobs::$_data['totalappliedresume']; ?></span>
...
<script type="text/javascript">
            ...
            var data = new google.visualization.DataTable();
                    ...
                    data.addRows([
<?php echo jsjobs::$_data['line_chart_json_array']; ?>
                    ]);
                    var options = {
...
<?php echo jsjobs::$_data['citybar1']; ?>
            ]);
                    var view = new google.visualization.DataView(data);
                    view.setColumns([0, 1,
                    { calc: "stringify",
...
<?php echo jsjobs::$_data['citybar2']; ?>
            ]);
                    var view = new google.visualization.DataView(data);
                    view.setColumns([0, 1,
                    { calc: "stringify",
...
<?php echo jsjobs::$_data['jobtypebar1']; ?>
            ]);
                    var view = new google.visualization.DataView(data);
                    view.setColumns([0, 1,
                    { calc: "stringify",
...
<?php echo jsjobs::$_data['jobtypebar2']; ?>
            ]);
                    var view = new google.visualization.DataView(data);
                    view.setColumns([0, 1,
                    { calc: "stringify",
