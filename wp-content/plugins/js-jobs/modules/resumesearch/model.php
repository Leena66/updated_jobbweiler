...
class JSJOBSresumeSearchModel {
    ...
    function getSearchResume_Widget($title, $showtitle, $apptitle, $name, $natinality, $gender, $iamavailable, $category, $jobtype, $salaryrange, $heighesteducation, $experience, $columnperrow) {
        ...
        $html .='<form class="resume_form" id="resume_form" method="post" action="' . jsjobs::makeUrl(array('jsjobsme'=>'resume', 'jsjobslt'=>'resumes', 'jsjobspageid'=>jsjobs::getPageid())) . '">';
    ...
    function getMessagekey(){
        $key = 'resumesearch';if(is_admin()){$key = 'admin_'.$key;}return $key;
    }
}
