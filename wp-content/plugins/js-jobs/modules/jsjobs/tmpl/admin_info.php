...
<div id="jsjobsadmin-wrapper">
    ...
    <div class="js-admin-joomsky-wrapper ">
        <span class="js-admin-title">
            <img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/aboutus_page/logo.png" />
        </span>
    ...
    <div class="products">
        <div class="components" id="jobs-free">
            <img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/aboutus_page/joomla.png" />
        ...
        <div class="components" id="autoz-pro">
            <img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/aboutus_page/wordpress.png" />
            <span class="component-text">
                <span class="component-title">
                    <?php echo __('JS Jobs', 'js-jobs'); ?>
                </span>    
        ...
        <div class="components" id="ticket-free">
            ...
            <span class="info-urls">
                <a class="pro" href="http://www.joomsky.com/products/js-supprot-ticket-pro-joomla.html">
                    <?php echo __('Pro Download', 'js-jobs'); ?>
                </a>
                <a class="free" href="http://www.joomsky.com/products/js-supprot-ticket-joomla.html">
                    <?php echo __('Free Download', 'js-jobs'); ?>
                </a>
            </span>
        </div>
        <div class="components" id="autoz-free">
            ...
            <span class="info-urls">
                <a class="pro" href="http://www.joomsky.com/products/js-supprot-ticket-pro-wp.html">
                    <?php echo __('Pro Download', 'js-jobs'); ?>
                </a>
                <a class="free" href="http://www.joomsky.com/products/js-supprot-ticket-wp.html">
                    <?php echo __('Free Download', 'js-jobs'); ?>
                </a>
            </span>
        </div>
        <div class="components" id="ticket-pro">
            <img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/aboutus_page/joomla.png" />
            <span class="component-text">
                <span class="component-title">
                    <?php echo __('JS Autoz', 'js-jobs'); ?>
                </span>    
                <span class="component-type">
                    <?php echo __('Joomla', 'js-jobs'); ?>
                </span>    
                <span class="component-detail">
                    <?php echo __('JS Autoz is robust and powerful vehicles show room component for Joomla. JS Autoz help you build online show room with clicks. With admin power you can easily manage makes, models, types etc. in admin area.', 'js-jobs'); ?>
                </span>    
            </span>
            <span class="info-urls">
                <a class="pro" href="http://www.joomsky.com/products/js-autoz-pro.html">
                    <?php echo __('Pro Download', 'js-jobs'); ?>
                </a>
                <a class="free" href="http://www.joomsky.com/products/js-autoz.html">
                    <?php echo __('Free Download', 'js-jobs'); ?>
                </a>
            </span>
        </div>
