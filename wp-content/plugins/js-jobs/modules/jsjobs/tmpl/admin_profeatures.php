    ...
    <div id="jsjobsadmin-data">
            ...
            <div id="js_profeature_main_wrapper">
        		<div id="proheading" class="proheading">
        			...
        			<a class="buynow" target="_blank" href="http://www.joomsky.com/products/js-jobs-pro-wp.html"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/pro/buy-now.png"> <?php echo __('BUY NOW','wp-jobs');?></a>
        		</div>
            	<div class="topimage bgwhite"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/pro/image-1.png"></div>
            	<div class="pro_wrapper">
            		<div class="small_box">
            			<div class="box bgwhite">
            				<div class="img"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/pro/add-job.png"></div>
            				<div class="data">
        ...
        JS Jobs send him an edit job link in his email.</div>
            		...
            		<div class="small_box">
            			<div class="box bgwhite">
            				<div class="img"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/pro/gold-feature.png"></div>
            				<div class="data">
        ...
        Featured jobs are not just listing in different layout it can also be listed in Newest Jobs controllable by admin.</div>
            	...
            	<div class="pro_wrapper">
            		<div class="small_box">
            			<div class="box bgwhite">
            				<div class="img"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/pro/tell-friend.png"></div>
            				<div class="data">
            		...
            		<div class="small_box">
            			<div class="box bgwhite">
            				<div class="img"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/pro/message.png"></div>
            				<div class="data">
        ...
        On each message JS Jobs send email notification.</div>
        		...
        		<div class="full_box">
        			<div class="box bgwhite">
        				<div class="img"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/pro/themes.png"></div>
        				<div class="data">
        ...
        You can either select colors from a color pallet table or select the predefined set.</div>
            	...
            	<div class="pro_wrapper">
            		<div class="small_box">
            			<div class="box bgwhite">
            				<div class="img"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/pro/credits-log.png"></div>
            				<div class="data">
        ...
        whenever any user or admin performs any action the Credits log is updated with the user name, cost and basic descrption of that action.</div>
            		...
            		<div class="small_box">
            			<div class="box bgwhite">
            				<div class="img"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/pro/multi-credits.png"></div>
            				<div class="data">
        ...
        Whenever any user perform any of the those actions, he/she is charged for that specific action.</div>
            	...
            	<div class="pro_wrapper">
            		<div class="small_box">
            			<div class="box bgwhite">
            				<div class="img"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/pro/view-resume-detials.png"></div>
            				<div class="data">
            		...
            		<div class="small_box">
            			<div class="box bgwhite">
            				<div class="img"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/pro/add-resume.png"></div>
            				<div class="data">
                ...
                <div class="full_box">
                    <div class="box bgwhite">
                        <div class="img"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/pro/credits.png"></div>
                        <div class="data">
        ...
        Users buy credit packs defined by admin using paypal or woocommrece.</div>
            	...
            	<div class="pro_wrapper">
            		<div class="small_box">
            			<div class="box bgwhite">
            				<div class="img"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/pro/suggets-jobs.png"></div>
            				<div class="data">
            		...
            		<div class="small_box">
            			<div class="box bgwhite">
            				<div class="img"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/pro/apply-social.png"></div>
            				<div class="data">
        ...
        <img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/pro/facebook.png">&nbsp;&nbsp;Facebook<br>
        <img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/pro/in.png">&nbsp;&nbsp;Linkedin<br>
        <img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/pro/xing.png">&nbsp;&nbsp;Xing</div>
            				</div>
            			</div>
            		</div>
            	</div>
            	<div class="pro_wrapper">
            		<div class="small_box">
            			<div class="box bgwhite">
            				<div class="img"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/pro/login-social.png"></div>
            				<div class="data">
        ...
        <img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/pro/facebook.png">&nbsp;&nbsp;Facebook<br>
        <img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/pro/in.png">&nbsp;&nbsp;Linkedin<br>
        <img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/pro/xing.png">&nbsp;&nbsp;Xing
        </div>
            				</div>
            			</div>
            		</div>
            		<div class="small_box">
            			<div class="box bgwhite">
            				<div class="img"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/pro/tags.png"></div>
            				<div class="data">
                ...
                <div class="full_box">
                    <div class="box bgwhite">
                        <div class="img"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/pro/applied-jobs.png"></div>
                        <div class="data">
        ...
        It help employer to find best candidate for his job.</div>
                ...
                <div class="pro_wrapper">
                    <div class="small_box">
                        <div class="box bgwhite">
                            <div class="img"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/pro/job-alert.png"></div>
                            <div class="data">
                    ...
                    <div class="small_box">
                        <div class="box bgwhite">
                            <div class="img"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/pro/custom-fields.png"></div>
                            <div class="data">
        ...
        Admin can make custom fields visible on search forms, refine search popup and on main listings.</div>
                ...
                <div class="pro_wrapper">
                    <div class="small_box">
                        <div class="box bgwhite">
                            <div class="img"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/pro/career-bulider.png"></div>
                            <div class="data">
                    ...
                    <div class="small_box">
                        <div class="box bgwhite">
                            <div class="img"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/pro/indeed.png"></div>
                            <div class="data">
        		...
        		<div class="full_box">
        			<div class="box bgwhite">
        				<div class="img"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/pro/notifications.png"></div>
        				<div class="data">
        ...
        job apply ,job applied resume status change or when someone sends a message or replies to a message.</div>
            	...
            	<div class="pro_wrapper">
            		<div class="small_box">
            			<div class="box bgwhite">
            				<div class="img"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/pro/paypal.png"></div>
            				<div class="data">
            		...
            		<div class="small_box">
            			<div class="box bgwhite">
            				<div class="img"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/pro/woo.png"></div>
            				<div class="data">
