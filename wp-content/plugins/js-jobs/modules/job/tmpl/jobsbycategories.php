        ...
        if (isset(jsjobs::$_data[0]) && !empty(jsjobs::$_data[0])) {
            foreach (jsjobs::$_data[0] AS $jobsByCategories) {
                ...
                <div class="category-wrapper" style="width:<?php echo $width; ?>%;" data-id="<?php echo $jobsByCategories->aliasid; ?>">
                    <a href="<?php echo jsjobs::makeUrl(array('jsjobsme'=>'job', 'jsjobslt'=>'jobs', 'category'=>$jobsByCategories->aliasid)); ?>">
...
//                              $link = jsjobs::makeUrl(array('jsjobsme'=>'resume', 'jsjobslt'=>'resumes', 'category'=>$cat->aliasid));
                                $link = jsjobs::makeUrl(array('jsjobsme'=>'job', 'jsjobslt'=>'jobs', 'category'=>$cat->aliasid));
