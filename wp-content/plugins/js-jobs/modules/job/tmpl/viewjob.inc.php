...
if($mapfield):
    ...
    if($mapfield->published == 1){ ?>
        ...
        <input type="hidden" id="longitude" name="longitude" value="<?php echo jsjobs::$_data[0]->longitude; ?>"/>
        <input type="hidden" id="latitude" name="latitude" value="<?php echo jsjobs::$_data[0]->latitude; ?>"/>
