...
wp_enqueue_style('status-graph', jsjobs::$_pluginpath . 'includes/css/status_graph.css');
...
if (jsjobs::$_error_flag == null) {
    ...
    <div id="jsjobs-wrapper">
        <div class="page_heading">
            ...
            <a class="additem" href="<?php echo jsjobs::makeUrl(array('jsjobsme'=>'resume', 'jsjobslt'=>'addresume', 'jsjobspageid'=>jsjobs::getPageid())); ?>"><?php echo __('Add New','js-jobs') .'&nbsp;'. __('Resume', 'js-jobs'); ?></a>
        </div>
        <?php
        ...
        <div id="my-resume-header">
            <ul>
                <li>
                    <a href="<?php echo jsjobs::makeUrl(array('jsjobsme'=>'resume', 'jsjobslt'=>'myresumes', 'sortby' => jsjobs::$_sortlinks['title'], 'jsjobspageid'=>jsjobs::getPageid())) ?>" class="<?php
                ...
                <li>
                    <a href="<?php echo jsjobs::makeUrl(array('jsjobsme'=>'resume', 'jsjobslt'=>'myresumes', 'sortby' => jsjobs::$_sortlinks['jobtype'], 'jsjobspageid'=>jsjobs::getPageid())) ?>" class="<?php
                ...
                <li>
                    <a href="<?php echo jsjobs::makeUrl(array('jsjobsme'=>'resume', 'jsjobslt'=>'myresumes', 'sortby' => jsjobs::$_sortlinks['salary'], 'jsjobspageid'=>jsjobs::getPageid())) ?>" class="<?php
                ...
                <li>
                    <a href="<?php echo jsjobs::makeUrl(array('jsjobsme'=>'resume', 'jsjobslt'=>'myresumes', 'sortby' => jsjobs::$_sortlinks['posted'], 'jsjobspageid'=>jsjobs::getPageid())) ?>" class="<?php
        ...
        ?>"><?php if (jsjobs::$_sorton == 'posted') { ?> <img src="<?php echo jsjobs::$_pluginpath . 'includes/images/' . $img ?>"> <?php } ?><?php echo __('Posted', 'js-jobs'); ?></a>
            ...
            if (!empty(jsjobs::$_data[0])) {
                foreach (jsjobs::$_data[0] AS $myresume) {
                    ...
                    ?>
                <div class="my-resume-data object_<?php echo $myresume->id; ?>">
            <?php
            $wpdir = wp_upload_dir();
            if ($myresume->photo != "") {
                ...
                $photourl = jsjobs::$_pluginpath . '/includes/images/users.png';
            }
            ?>
                    <div class="my-resume-listing-img-modified-wrapper" >
                        <span class="fir">
                            <a href="<?php echo jsjobs::makeUrl(array('jsjobsme'=>'resume', 'jsjobslt'=>'viewresume', 'jsjobsid'=>$myresume->id, 'jsjobspageid'=>jsjobs::getPageid())); ?>">
                        ...
                        <span class="my-resume-modified-date" >
                            ...
                            <span class="my-resume-modified-date-value" >
                                <?php echo date_i18n($dateformat,strtotime($myresume->last_modified)); ?>
                            </span>
                        </span>
                    </div>
                    <div class="data-bigupper">
                        <div class="big-upper-upper">
                            <div class="headingtext item-title">
                                <span class="title"><?php echo $myresume->first_name . " " . $myresume->last_name; ?></span>
                            </div>
                            <span class="buttonu"><?php echo __($myresume->jobtypetitle,'js-jobs'); ?></span><span class="datecreated"><?php echo __('Created', 'js-jobs') . ':&nbsp;' . date_i18n($dateformat, strtotime($myresume->created)); ?></span>
                        </div>
                        <div class="big-upper-lower listing-fields">
                            <div class="myresume-list-bottom-left">
                                <span class="lower-upper-title">(
                                    <a href="<?php echo jsjobs::makeUrl(array('jsjobsme'=>'resume', 'jsjobslt'=>'viewresume', 'jsjobsid'=>$myresume->id, 'jsjobspageid'=>jsjobs::getPageid())); ?>">
                                        <?php echo $myresume->application_title; ?>
                                    </a>)
                                </span>
                                <div class="custom-field-wrapper">
                                    <span class="js-bold"><?php echo __(jsjobs::$_data['fields']['email_address'], 'js-jobs') . ':&nbsp;'; ?></span>
                                ...
                                <div class="custom-field-wrapper">
                                    <span class="js-bold"><?php echo __(jsjobs::$_data['fields']['job_category'], 'js-jobs') . ':&nbsp;'; ?></span>
                                ...
                                foreach ($customfields as $field) {
                                    echo JSJOBSincluder::getObjectClass('customfields')->showCustomFields($field, 9,$myresume->params);
                                }
                                //end
                                ?>
                            </div>
                            <div class="myresume-list-data-profile myresume-complete-status" data-per="<?php echo $percentage; ?>" >
                    ...
                    <div class="data-big-lower">
                        <span class="big-lower-left">  
                            <img class="big-lower-img" src="<?php echo jsjobs::$_pluginpath; ?>includes/images/location.png"><?php echo $myresume->location; ?>
                        </span> 
                            <?php if ($myresume->status == 1) {
                                $config_array_res = jsjobs::$_data['config'];
                             ?>
                        <div class="big-lower-data-icons">
                            <a href="<?php echo jsjobs::makeUrl(array('jsjobsme'=>'resume', 'jsjobslt'=>'addresume', 'jsjobsid'=>$myresume->id, 'jsjobspageid'=>jsjobs::getPageid())); ?>"><img class="icon-img" src="<?php echo jsjobs::$_pluginpath; ?>includes/images/fe-edit.png" alt="<?php echo __('Edit', 'js-jobs'); ?>" title="<?php echo __('Edit', 'js-jobs'); ?>"/></a>
                            <a href="<?php echo jsjobs::makeUrl(array('jsjobsme'=>'resume', 'jsjobslt'=>'viewresume', 'jsjobsid'=>$myresume->id, 'jsjobspageid'=>jsjobs::getPageid())); ?>"><img class="icon-img" src="<?php echo jsjobs::$_pluginpath; ?>includes/images/fe-view.png" alt="<?php echo __('View', 'js-jobs'); ?>" title="<?php echo __('View', 'js-jobs'); ?>"/></a>
                            <a href="<?php echo jsjobs::makeUrl(array('jsjobsme'=>'resume', 'task'=>'removeresume', 'action'=>'jsjobtask', 'jsjobs-cb[]'=>$myresume->id, 'jsjobspageid'=>jsjobs::getPageid())); ?>"onclick="return confirmdelete('<?php echo __('Are you sure to delete','js-jobs').' ?'; ?>');"><img class="icon-img" src="<?php echo jsjobs::$_pluginpath; ?>includes/images/fe-force-delete.png" alt="<?php echo __('Delete', 'js-jobs'); ?>" title="<?php echo __('Delete', 'js-jobs'); ?>"/></a>
                        </div>
            <?php } elseif ($myresume->status == 0) { ?>
                            <div class="big-lower-data-text"><img id="pending-img"  src="<?php echo jsjobs::$_pluginpath; ?>includes/images/pending-corner.png"/><?php echo __('Waiting for approval', 'js-jobs'); ?></div>
            <?php }elseif ($myresume->status == -1){ ?>
                            <div class="big-lower-data-text rjctd"><img id="pending-img"  src="<?php echo jsjobs::$_pluginpath; ?>includes/images/reject-cornor.png"/><?php echo __('Rejected', 'js-jobs'); ?></div>
            <?php
                } ?>
                    </div>
                </div>
        ...
        echo JSJOBSlayout::getNoRecordFound($msg,$links);
    }
?>
    </div>
<?php
