    ...
    <div id="jsjobs-wrapper">
        ...
        <div class="jsjobs-bottom-wrapper">
            <div class="js-topstats">
                <div class="js-mainwrp js-col-xs-12 js-col-md-4">
                    <div class="resume tprow">
                        <img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/stats/total-resume.png">
                        <div class="js-headtext"><?php echo __('Total resume','js-jobs'); ?></div>
                        <div class="js-count">(<?php echo jsjobs::$_data[0]['totalresume']; ?>)</div>
                    </div>
                </div>
                <div class="js-mainwrp js-col-xs-12 js-col-md-4">
                    <div class="coverletter tprow">
                        <img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/stats/total-coverletter.png">
                        <div class="js-headtext"><?php echo __('Cover letter','js-jobs'); ?></div>
                        <div class="js-count">(<?php echo jsjobs::$_data[0]['totalcoverletter']; ?>)</div>
                    </div>
                </div>
                <div class="js-mainwrp js-col-xs-12 js-col-md-4">
            ...
            <table id="js-table" class="jsjobs-first-table">
                <thead class="stats">
                    <tr>
                        <th class="title"><img class="table-image" src="<?php echo jsjobs::$_pluginpath; ?>includes/images/stats/resume-stats.png"><?php echo __('Resume','js-jobs');?></th>
