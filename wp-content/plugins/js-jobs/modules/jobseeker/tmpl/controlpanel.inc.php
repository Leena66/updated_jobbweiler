...
<div id="jsjobs-popup" class="loginpopup">
    <span class="popup-title"><?php echo __('Login','js-jobs'); ?><img id="popup_cross" src="<?php echo jsjobs::$_pluginpath . 'includes/images/popup-close.png'; ?>"></span>
        ...
        <?php
            if (!is_user_logged_in()) {
                ...
                if ($config_array['loginwithfacebook'] == 1) {
                    echo '<a class="sociallogin facebook" href="' . jsjobs::makeUrl(array('jsjobsme'=>'user', 'action'=>'jsjobtask', 'task'=>'sociallogin', 'media'=>'facebook', 'jsjobspageid'=>jsjobs::getPageid())) . '" ><img src="' . jsjobs::$_pluginpath . 'includes/images/scico/fb.png"/>' . __('Login with facebook', 'js-jobs') . '</a>';
                }
                if ($config_array['loginwithlinkedin'] == 1) {
                    echo '<a class="sociallogin linkedin" href="' . jsjobs::makeUrl(array('jsjobsme'=>'user', 'action'=>'jsjobtask', 'task'=>'sociallogin', 'media'=>'linkedin', 'jsjobspageid'=>jsjobs::getPageid())) . '" ><img src="' . jsjobs::$_pluginpath . 'includes/images/scico/in.png"/>' . __('Login with linkedin', 'js-jobs') . '</a>';
                }
                if ($config_array['loginwithxing'] == 1) {
                    echo '<a class="sociallogin xing" href="' . jsjobs::makeUrl(array('jsjobsme'=>'user', 'action'=>'jsjobtask', 'task'=>'sociallogin', 'media'=>'xing', 'jsjobspageid'=>jsjobs::getPageid())) . '" ><img src="' . jsjobs::$_pluginpath . 'includes/images/scico/xing.png"/>' . __('Login with xing', 'js-jobs') . '</a>';
                }            
            } 
        ?>
    </div>
