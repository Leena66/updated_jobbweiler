...
class JSJOBSUserModel {
    ...
    function getAllUsers() {
        ...
        $searchusername = JSJOBSrequest::getVar('searchusername');
        $searchrole = JSJOBSrequest::getVar('searchrole');
        $searchcompany = JSJOBSrequest::getVar('searchcompany');
        $searchresume = JSJOBSrequest::getVar('searchresume');
        ...
        if ($formsearch == 'JSJOBS_SEARCH') {
            ...
            $_SESSION['JSJOBS_SEARCH']['searchusername'] = $searchusername;
            $_SESSION['JSJOBS_SEARCH']['searchrole'] = $searchrole;
            $_SESSION['JSJOBS_SEARCH']['searchcompany'] = $searchcompany;
            $_SESSION['JSJOBS_SEARCH']['searchresume'] = $searchresume;
        }
        if (JSJOBSrequest::getVar('pagenum', 'get', null) != null) {
            ...
            $searchusername = (isset($_SESSION['JSJOBS_SEARCH']['searchusername']) && $_SESSION['JSJOBS_SEARCH']['searchusername'] != '') ? $_SESSION['JSJOBS_SEARCH']['searchusername'] : null;
            $searchrole = (isset($_SESSION['JSJOBS_SEARCH']['searchrole']) && $_SESSION['JSJOBS_SEARCH']['searchrole'] != '') ? $_SESSION['JSJOBS_SEARCH']['searchrole'] : null;
            ...
            $searchresume = (isset($_SESSION['JSJOBS_SEARCH']['searchresume']) && $_SESSION['JSJOBS_SEARCH']['searchresume'] != '') ? $_SESSION['JSJOBS_SEARCH']['searchresume'] : null;
   ...
   function enforceDeleteOurUser($uid, $roleid) {
    ...
    function userCanDelete($uid, $roleid) {
        ...
        if ($roleid == 1) { // employer
            $query = "SELECT 
                ...
                +   (SELECT COUNT(evr.id) FROM `" . jsjobs::$_db->prefix . "js_job_employer_view_resume` AS evr WHERE evr.uid = $uid )
                AS total
            ";
        }
    ...
    function getMessagekey(){
        $key = 'user';if(is_admin()){$key = 'admin_'.$key;}return $key;
    }
