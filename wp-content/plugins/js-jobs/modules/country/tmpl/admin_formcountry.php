...
<div id="jsjobsadmin-wrapper">
    ...
    <span class="js-admin-title">
        ...
        echo $heading . '&nbsp' . __('Country', 'js-jobs'); ?>
    </span>
    <form id="jsjobs-form" method="post" action="<?php echo admin_url("admin.php?page=jsjobs_country&task=savecountry"); ?>">
        ...
        <?php echo JSJOBSformfield::hidden('action', 'country_savecountry'); ?>
        ...
        <div class="js-submit-container js-col-lg-8 js-col-md-8 js-col-md-offset-2 js-col-md-offset-2">
            <a id="form-cancel-button" href="<?php echo admin_url('admin.php?page=jsjobs_country'); ?>" ><?php echo __('Cancel', 'js-jobs'); ?></a>
            <?php echo JSJOBSformfield::submitbutton('save', __('Save','js-jobs') .' '. __('Country', 'js-jobs'), array('class' => 'button')); ?>
        </div>
    </form>
</div>
</div>
