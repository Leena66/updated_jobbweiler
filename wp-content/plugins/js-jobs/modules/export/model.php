...
class JSJOBSExportModel {
                    ...
                    foreach($fields AS $key => $value){
                        switch ($key) {
                            case "application_title":
                                $returnvalue['personal'][$fieldsarray['fieldtitles'][$section][$key]] = $result['personal']->application_title;
                                break;
                            case "first_name":
                                $returnvalue['personal'][$fieldsarray['fieldtitles'][$section][$key]] = $result['personal']->first_name;
                                break;
                            case "middle_name":
                                $returnvalue['personal'][$fieldsarray['fieldtitles'][$section][$key]] = $result['personal']->middle_name;
                                break;
                            case "last_name":
                                $returnvalue['personal'][$fieldsarray['fieldtitles'][$section][$key]] = $result['personal']->last_name;
                                break;
                            case "email_address":
                                $returnvalue['personal'][$fieldsarray['fieldtitles'][$section][$key]] = $result['personal']->email_address;
                                break;
                            case "nationality":
                                $returnvalue['personal'][$fieldsarray['fieldtitles'][$section][$key]] = $result['personal']->nationality;
                                break;
                            case "date_of_birth":
                                $returnvalue['personal'][$fieldsarray['fieldtitles'][$section][$key]] = $result['personal']->date_of_birth;
                                break;
                            case "gender":
                                ...
                                $returnvalue['personal'][$fieldsarray['fieldtitles'][$section][$key]] = $result['personal']->gender;
                                break;
                            case "iamavailable":
                            ...
                            case "searchable":
                                ...
                                break;
                            case "home_phone":
                                $returnvalue['personal'][$fieldsarray['fieldtitles'][$section][$key]] = $result['personal']->home_phone;
                                break;
                            case "work_phone":
                                $returnvalue['personal'][$fieldsarray['fieldtitles'][$section][$key]] = $result['personal']->work_phone;
                                break;
                            case "job_category":
                                $returnvalue['personal'][$fieldsarray['fieldtitles'][$section][$key]] = $result['personal']->job_category;
                                break;
                            case "salary":
                                $returnvalue['personal'][$fieldsarray['fieldtitles'][$section][$key]] = $result['personal']->salary;
                                break;
                            case "jobtype":
                                $returnvalue['personal'][$fieldsarray['fieldtitles'][$section][$key]] = $result['personal']->jobtype;
                                break;
                            case "heighestfinisheducation":
                                $returnvalue['personal'][$fieldsarray['fieldtitles'][$section][$key]] = $result['personal']->heighestfinisheducation;
                                break;
                            case "date_start":
                                $returnvalue['personal'][$fieldsarray['fieldtitles'][$section][$key]] = $result['personal']->date_start;
                                break;
                            case "total_experience":
                                $returnvalue['personal'][$fieldsarray['fieldtitles'][$section][$key]] = $result['personal']->total_experience;
                                break;
    ...
    function getMessagekey(){
        $key = 'export';if(is_admin()){$key = 'admin_'.$key;}return $key;
    }
