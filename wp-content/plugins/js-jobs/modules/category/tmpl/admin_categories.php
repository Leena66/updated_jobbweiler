...
<div id="jsjobsadmin-wrapper">
    ...
    <span class="js-admin-title">
        ...
        <a class="js-button-link button" href="<?php echo admin_url('admin.php?page=jsjobs_category&jsjobslt=formcategory'); ?>"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/add_icon.png" /><?php echo __('Add New','js-jobs') .'&nbsp;'. __('Category', 'js-jobs') ?></a>
    </span>
    ...
    <form class="js-filter-form" name="jsjobsform" id="jsjobsform" method="post" action="<?php echo admin_url("admin.php?page=jsjobs_category"); ?>">
    ...
    if (!empty(jsjobs::$_data[0])) {
        ?>  		
        <form id="jsjobs-list-form" method="post" action="<?php echo admin_url("admin.php?page=jsjobs_category"); ?>">
            <table id="js-table">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    for ($i = 0, $n = count(jsjobs::$_data[0]); $i < $n; $i++) {
                        ...
                        <tr valign="top">
                            ...
                            <td class="left-row">
                                <a href="<?php echo admin_url('admin.php?page=jsjobs_category&jsjobslt=formcategory&jsjobsid='.$row->id); ?>"><?php echo __($row->cat_title,'js-jobs'); ?></a>
                            </td>
                            <td>
                                <?php if ($row->isdefault == 1) { ?>
                                    <img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/default.png" alt="Default" />
                                <?php } else { ?>
                                    <a href="<?php echo admin_url('admin.php?page=jsjobs_common&task=makedefault&action=jsjobtask&for=categories&id='.$row->id.$pageid); ?>">
                            ...
                            <td>
                                <?php if ($row->isactive == 1) { ?> 
                                    <a href="<?php echo admin_url('admin.php?page=jsjobs_category&task=unpublish&action=jsjobtask&jsjobs-cb[]='.$row->id.$pageid); ?>">
                                        <img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/yes.png" alt="<?php echo __('Published', 'js-jobs'); ?>" />
                                    </a>
                                <?php } else { ?>
                                    <a href="<?php echo admin_url('admin.php?page=jsjobs_category&task=publish&action=jsjobtask&jsjobs-cb[]='.$row->id.$pageid); ?>">
                            ...
                            <td>
                                <?php if ($i != 0 || $pagenum > 1) { ?>
                                    <a href="<?php echo admin_url('admin.php?page=jsjobs_common&task=defaultorderingup&action=jsjobtask&for=categories&id='.$row->id.$pageid); ?>">
                                        <img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/<?php echo $upimg; ?>" alt="Order Up" />
                                    </a>
                                <?php } else echo ''; ?>	
                                <?php echo $row->ordering; ?>
                                <?php if ($i < $n - 1 || $islastordershow) { ?>
                                    <a href="<?php echo admin_url('admin.php?page=jsjobs_common&task=defaultorderingdown&action=jsjobtask&for=categories&id='.$row->id.$pageid); ?>">
                                        <img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/<?php echo $downimg; ?>" alt="Order Down" />
                                    </a>
                                <?php } ?>	
                            </td>
                            <td class="action">
                                <a href="<?php echo admin_url('admin.php?page=jsjobs_category&jsjobslt=formcategory&jsjobsid='.$row->id); ?>"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/edit.png" title="<?php echo __('Edit', 'js-jobs'); ?>"></a>
                                <a href="<?php echo admin_url('admin.php?page=jsjobs_category&task=remove&action=jsjobtask&jsjobs-cb[]='.$row->id); ?>" onclick="return confirmdelete('<?php echo __('Are you sure to delete', 'js-jobs').' ?'; ?>');"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/remove.png" title="<?php echo __('Delete', 'js-jobs'); ?>"></a>
                            </td>
                        </tr>
                <?php
                    }
            ...
            <?php echo JSJOBSformfield::hidden('action', 'category_remove'); ?>
        ...
        $link[] = array(
                    'link' => 'admin.php?page=jsjobs_category&jsjobslt=formcategory',
