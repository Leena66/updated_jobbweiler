...
<div id="jsjobsadmin-wrapper">
    ...
    <form id="jsjobs-list-form" enctype="multipart/form-data" method="post" action="<?php echo admin_url('admin.php?page=jsjobs_addressdata'); ?>">
        <div id="loadaddressdata_wrapper">
            <div id="loadaddressdata_upper">
                <img id="loadaddressdata_companylogo" src="<?php echo jsjobs::$_pluginpath; ?>includes/images/add_logo.png" />
                ...
                <a href="http://www.joomsky.com/index.php/download-buy/product/product/8/43" target="_blank" ><img id="loadaddressdata_downloadbutton" src="<?php echo jsjobs::$_pluginpath; ?>includes/images/loadaddressdownloadbutton.png"/></a>
            </div>
        ...
        <?php echo JSJOBSformfield::hidden('task', 'loadaddressdata'); ?>
        <?php echo JSJOBSformfield::hidden('action', 'addressdata_loadaddressdata'); ?>
