    ...
    function loadaddressdata() {
        ...
        if ($_FILES['loadaddressdata']['size'] > 0) {
            ...
            if(($filestring != false) AND ($fileowner == 2)){
                ...
                $hasstate = strpos($filestring, '#__js_job_states');
                $hascities = strpos($filestring, '#__js_job_cities');
                
                if (($hasstate) AND ($hascities)) {

                    $filestring = str_replace('#__', jsjobs::$_db->prefix, $filestring);
                    ...
                    if($option == 1){
                        ...
                        $queries = str_replace('js_job_states', 'js_job_states_new', $queries);
                        $queries = str_replace('js_job_cities', 'js_job_cities_new', $queries);
