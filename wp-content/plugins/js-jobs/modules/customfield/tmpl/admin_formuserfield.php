...
<div id="jsjobsadmin-wrapper">
    ...
    <span class="js-admin-title">
        <a href="<?php echo admin_url('admin.php?page=jsjobs_fieldordering'); ?>"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/back-icon.png" /></a>
        <?php
    ...
    <form id="jsjobs-form" method="post" action="<?php echo admin_url("admin.php?page=jsjobs_fieldordering&task=saveuserfield"); ?>">
        <div class="js-field-wrapper js-row no-margin">
            ...
            <div class="js-field-obj js-col-lg-9 js-col-md-9 no-padding"><?php echo JSJOBSformfield::select('userfieldtype', $fieldtypes, isset(jsjobs::$_data[0]['userfield']->userfieldtype) ? jsjobs::$_data[0]['userfield']->userfieldtype : 'text', '', array('class' => 'inputbox one', 'data-validation' => 'required', 'onchange' => 'toggleType(this.options[this.selectedIndex].value);')); ?></div>
        </div>
        ...
        <div class="js-field-wrapper js-row no-margin">
            ...
            <div class="js-field-obj js-col-lg-9 js-col-md-9 no-padding"><?php echo JSJOBSformfield::text('field', isset(jsjobs::$_data[0]['userfield']->field) ? jsjobs::$_data[0]['userfield']->field : '', array('class' => 'inputbox one', 'data-validation' => 'required', 'onchange' => 'prep4SQL(this);')); ?></div>
        </div>
        <div class="js-field-wrapper js-row no-margin">
        ...
        <?php if (jsjobs::$_data[0]['fieldfor'] == 3) { ?>
            <div class="js-field-wrapper js-row no-margin">
                ...
                <div class="js-field-obj js-col-lg-9 js-col-md-9 no-padding"><?php echo JSJOBSformfield::select('section', $sectionarray, isset(jsjobs::$_data[0]['userfield']->section) ? jsjobs::$_data[0]['userfield']->section : '', '', array('class' => 'inputbox one', 'data-validation' => 'required')); ?></div>
            </div>
        <?php } ?>
        <div class="js-field-wrapper js-row no-margin">
            <div class="js-field-title js-col-lg-3 js-col-md-3 no-padding"><?php echo __('Read Only', 'js-jobs'); ?></div>
            <div class="js-field-obj js-col-lg-9 js-col-md-9 no-padding"><?php echo JSJOBSformfield::select('readonly', $yesno, isset(jsjobs::$_data[0]['userfield']->readonly) ? jsjobs::$_data[0]['userfield']->readonly : 0, '', array('class' => 'inputbox one')); ?></div>
        </div>
        <div class="js-field-wrapper js-row no-margin">
        ...
        <div id="divValues" class="js-field-wrapper divColsRows js-row no-margin">
            ...
            <div class="page-actions js-row no-margin">
                ...
                <div class="add-action js-col-lg-4 js-col-md-4 no-padding">
                    <a class="js-button-link button" href="javascript:void(0);" onclick="insertRow();"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/add_icon.png" /><?php echo __('Add Value', 'js-jobs') ?></a>
                </div>
            </div>
            <table id="js-table">
                <thead>
                ...
                <tbody id="fieldValuesBody">
                    ...
                    if (isset(jsjobs::$_data[0]['userfield']->type) && jsjobs::$_data[0]['userfield']->type == 'select') {
                        ...
                        <td width="10%"><a href="javascript:void(0);" data-rowid="jsjobs_trcust<?php echo $i; ?>" data-optionid="<?php echo $value->id; ?>"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/remove.png"></a></td>
                        </tr>
                        <?php
                        $i++;
                    }
                    ...
                    <tr id="jsjobs_trcust0">
                        ...
                        <td width="10%"><a data-rowid="jsjobs_trcust0" href="javascript:void(0);"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/remove.png"></a></td>
                    </tr>
                <?php } ?>		
                </tbody>
            </table>
        ...
        <?php echo JSJOBSformfield::hidden('valueCount', $i); ?>
        ...
        <?php echo JSJOBSformfield::hidden('action', 'customfield_saveuserfield'); ?>
    ...
    <script type="text/javascript">
        ...
        function comboOfFields() {
            ...
            jQuery.post(ajaxurl, {action: 'jsjobs_ajax', jsjobsme: 'fieldordering', task: 'getFieldsForComboByFieldFor', fieldfor: ff}, function (data) {
                if (data) {
                    console.log(data);
        ...
        function insertRow() {
            ...
            oImg.setAttribute('src', "<?php echo jsjobs::$_pluginpath; ?>includes/images/remove.png");
