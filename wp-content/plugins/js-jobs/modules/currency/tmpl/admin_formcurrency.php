...
<div id="jsjobsadmin-wrapper">
    ...
    <span class="js-admin-title">
        <a href="<?php echo admin_url('admin.php?page=jsjobs_currency'); ?>"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/back-icon.png" /></a>
        <?php
        $heading = isset(jsjobs::$_data[0]) ? __('Edit', 'js-jobs') : __('Add New', 'js-jobs');
        echo $heading . '&nbsp' . __('Currency', 'js-jobs');
        ?>
 </span>

    <form id="jsjobs-form" method="post" action="<?php echo admin_url("admin.php?page=jsjobs_currency&task=savecurrency"); ?>">
        ...
        <div class="js-field-wrapper js-row no-margin">
            ...
            <div class="js-field-obj js-col-lg-9 js-col-md-9 no-padding"><?php echo JSJOBSformfield::text('symbol', isset(jsjobs::$_data[0]->symbol) ? jsjobs::$_data[0]->symbol : '', array('class' => 'inputbox one', 'data-validation' => 'required')) ?></div>
        </div>
        <div class="js-field-wrapper js-row no-margin">
            ...
            <div class="js-field-obj js-col-lg-9 js-col-md-9 no-padding"><?php echo JSJOBSformfield::text('code', isset(jsjobs::$_data[0]->code) ? jsjobs::$_data[0]->code : '', array('class' => 'inputbox one', 'data-validation' => 'required')) ?></div>
        </div>
        <div class="js-field-wrapper js-row no-margin">
        ...
        <div class="js-field-wrapper js-row no-margin">
            ...
            <div class="js-field-obj js-col-lg-9 js-col-md-9 no-padding"><?php echo JSJOBSformfield::radiobutton('default', array('1' => __('Yes', 'js-jobs'), '0' => __('No', 'js-jobs')), isset(jsjobs::$_data[0]->default) ? jsjobs::$_data[0]->default : 0, array('class' => 'radiobutton')); ?></div>
        </div>
        ...
        <?php echo JSJOBSformfield::hidden('action', 'currency_savecurrency'); ?>
...
<?php echo JSJOBSformfield::hidden('form_request', 'jsjobs'); ?>
        <div class="js-submit-container js-col-lg-8 js-col-md-8 js-col-md-offset-2 js-col-md-offset-2">
            <a id="form-cancel-button" href="<?php echo admin_url('admin.php?page=jsjobs_currency'); ?>" ><?php echo __('Cancel', 'js-jobs'); ?></a>
<?php echo JSJOBSformfield::submitbutton('save', __('Save','js-jobs') .' '. __('Currency', 'js-jobs'), array('class' => 'button')); ?>
        </div>
    </form>
</div>
</div>