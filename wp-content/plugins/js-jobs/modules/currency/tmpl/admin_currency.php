...
<div id="jsjobsadmin-wrapper">
    ...
    <span class="js-admin-title">
        ...
        <a class="js-button-link button" href="<?php echo admin_url('admin.php?page=jsjobs_currency&jsjobslt=formcurrency'); ?>"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/add_icon.png" /><?php echo __('Add New','js-jobs') .'&nbsp;'. __('Currency', 'js-jobs') ?></a>
    </span>
    ...
    <form class="js-filter-form" name="jsjobsform" id="jsjobsform" method="post" action="<?php echo admin_url("admin.php?page=jsjobs_currency"); ?>">
        <?php echo JSJOBSformfield::text('title', jsjobs::$_data['filter']['title'], array('class' => 'inputbox', 'placeholder' => __('Title', 'js-jobs'))); ?>
        <?php echo JSJOBSformfield::text('code', jsjobs::$_data['filter']['code'], array('class' => 'inputbox', 'placeholder' => __('Currency Code', 'js-jobs'))); ?>
    ...
    if (!empty(jsjobs::$_data[0])) {
        ?>
        <form id="jsjobs-list-form" method="post" action="<?php echo admin_url("admin.php?page=jsjobs_currency"); ?>">
            <table id="js-table">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    for ($i = 0, $n = count(jsjobs::$_data[0]); $i < $n; $i++) {
                        ...
                        <tr valign="top">
                            ...
                            <td class="left-row">
                                <a href="<?php echo admin_url("admin.php?page=jsjobs_currency&jsjobslt=formcurrency&jsjobsid=".$row->id);?>">
                            ...
                            <td>
                                ...
                                <?php } else { ?>
                                    <a href="<?php echo admin_url('admin.php?page=jsjobs_common&task=makedefault&action=jsjobtask&for=currencies&id='.$row->id.$pageid); ?>">
        ...
        <?php } ?>	
                            ...
                            <td>
                                   <?php if ($row->status == 1) { ?> 
                                    <a href="<?php echo admin_url('admin.php?page=jsjobs_currency&task=unpublish&action=jsjobtask&jsjobs-cb[]='.$row->id.$pageid); ?>">
                                        <img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/yes.png" border="0" alt="<?php echo __('Published', 'js-jobs'); ?>" /></a>
                                   <?php } else { ?>
                                    <a href="<?php echo admin_url('admin.php?page=jsjobs_currency&task=publish&action=jsjobtask&jsjobs-cb[]='.$row->id.$pageid); ?>">
                            ...
                            <td>
                                <?php if ($i != 0 || $pagenum > 1) { ?>		
                                    <a href="<?php echo admin_url('admin.php?page=jsjobs_common&task=defaultorderingup&action=jsjobtask&for=currencies&id='.$row->id.$pageid); ?>">
                                ...
                                <?php if ($i < $n - 1 || $islastordershow) { ?>
                                    <a href="<?php echo admin_url('admin.php?page=jsjobs_common&task=defaultorderingdown&action=jsjobtask&for=currencies&id='.$row->id.$pageid); ?>">
                                        <img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/<?php echo $downimg; ?>" border="0" alt="<?php echo __('Order Down', 'js-jobs'); ?>" /></a>
        <?php } ?>	

                            </td>
                            <td class="action">
                                <a href="<?php echo admin_url('admin.php?page=jsjobs_currency&jsjobslt=formcurrency&jsjobsid='.$row->id); ?>"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/edit.png" title="<?php echo __('Edit', 'js-jobs'); ?>"></a>
                                <a href="<?php echo admin_url('admin.php?page=jsjobs_currency&task=remove&action=jsjobtask&jsjobs-cb[]='.$row->id); ?>" onclick="return confirmdelete('<?php echo __('Are you sure to delete', 'js-jobs').' ?'; ?>');"><img src="<?php echo jsjobs::$_pluginpath; ?>includes/images/remove.png" title="<?php echo __('Delete', 'js-jobs'); ?>"></a>
                            </td>
                        </tr>
                <?php
            }
        ...
        <?php echo JSJOBSformfield::hidden('action', 'currency_remove'); ?>
        ...
        $link[] = array(
                    'link' => 'admin.php?page=jsjobs_currency&jsjobslt=formcurrency',
