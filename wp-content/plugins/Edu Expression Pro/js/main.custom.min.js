...
function check_perform_edit(id)
{
    ...
    else
    {
        ...
        var target = id+"&info=edit&id="+SelectedItem;
        show_modal(target);
    }
}
...
{
    var target = controller+"&info=edit&id="+id;
    show_modal(target);
}
function check_perform_select(id,controller)
{
    ...
    else
    {
        ...
        var target = id+"&info="+controller+"&id="+SelectedItem;
         show_modal(target);
    }
}
...
$(document).ready(function(){
    ...
    allSelectedText: 'All Selected',filterPlaceholder: 'Search',nonSelectedText: 'None selected',enableFiltering: true,enableCaseInsensitiveFiltering: true});
