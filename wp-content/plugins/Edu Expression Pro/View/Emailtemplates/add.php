...
<div class="panel panel-custom">
    ...
    <form class="form-horizontal validate" action="<?php echo$this->url;?>&info=add" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                <?php echo$tinymce->input('description',$_POST['description'],array('placeholder'=>__('Email Template'),'class'=>'form-control','cols'=>'30','rows'=>'6'),array('language'=>$configLanguage,'directionality'=>$dirType),$editorType);?>
                </div>
            </div>
