            ...
            <table class="table table-striped table-bordered">
                <thead>
                    <tr>
                        ...
                        <th class="<?php echo $this->ExamApp->recordSorting($_REQUEST,'diff_level');?>"><a href="<?php echo$this->url;?>&info=index&orderby=diff_level&order=<?php echo$order;?>"><?php echo __('Name');?><span class="sorting-indicator"></span></a></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $this->ExamApp->h($post['diff_level']);?></td>
                        <td>
                            <div class="btn-group">
