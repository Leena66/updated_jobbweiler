...
<div <?php if(!$isError){?>class="container"<?php }?>>    
    <div class="panel panel-custom mrg">
        <div class="panel-heading"><?php echo __('Edit').'&nbsp;'.__('Subjects');?><?php if(!$isError){?><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button><?php }?></div>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
						<input type="text" name="data[<?php echo$k;?>][subject_name]" value="<?php echo $this->ExamApp->h($post['subject_name']);?>" class="form-control" placeholder="<?php echo __('Name');?>" required="required" />
						</div>
					</div>
					<div class="form-group">
						<div class="col-sm-9">
