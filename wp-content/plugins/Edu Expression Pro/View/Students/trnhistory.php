...
$(window).load(function() {
	$("#results" ).load( "<?php echo$this->ajaxUrl;?>&info=trnhistory",{<?php echo$order.$orderClause;?>}); //load initial records
});
$(document).ready(function() {
	...
	$("#results").load("<?php echo$this->ajaxUrl;?>&info=trnhistory",{<?php echo$order.$orderClause;?>"page":page,"ipage":ipage,"keyword":keyword}, function(){ //get content from PHP page
	...
	var keyword = $('.Keyword').val(); //get value from search
	$("#results").load("<?php echo$this->ajaxUrl;?>&info=trnhistory",{<?php echo$order.$orderClause;?>"ipage":page,"keyword":keyword}, function(){ //get content from PHP page
	$(".loading-div").hide(); //once done, hide loading element
	});
	});
});
