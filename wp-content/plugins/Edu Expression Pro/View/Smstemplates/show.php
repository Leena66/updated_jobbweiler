            ...
            <table class="table table-striped table-bordered">
                <thead>
                    <tr>
                        ...
                        <th class="<?php echo $this->ExamApp->recordSorting($_REQUEST,'description');?>"><a href="<?php echo$this->url;?>&info=index&orderby=description&order=<?php echo$order;?>"><?php echo __('Description');?><span class="sorting-indicator"></span></a></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $this->ExamApp->h($post['description']);?></td>
