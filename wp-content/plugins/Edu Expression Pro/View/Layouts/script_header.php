...
<html lang="en">
  <head>
	...
	<script type="text/javascript" src="<?php echo plugin_dir_url(__FILE__);?>../../js/highcharts/highcharts.js"></script>
	<script type="text/javascript" src="<?php echo plugin_dir_url(__FILE__);?>../../js/highcharts/themes/sand-signika.js"></script>
