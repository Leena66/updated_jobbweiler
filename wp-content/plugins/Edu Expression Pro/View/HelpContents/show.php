...
?>
<div class="page-title"> <div class="title-env"> <h1 class="title"><?php echo __('Help Contents');?></h1></div></div>
<div class="panel">
            ...
            <table class="table table-striped table-bordered">
                <thead>
                    <tr>
                        ...
                        <th class="<?php echo $this->ExamApp->recordSorting($_REQUEST,'name');?>"><a href="<?php echo$this->url;?>&info=index&orderby=name&order=<?php echo$order;?>"><?php echo __('Title');?><span class="sorting-indicator"></span></a></th>
